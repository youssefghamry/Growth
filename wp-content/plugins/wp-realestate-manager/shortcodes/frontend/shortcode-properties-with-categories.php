...
if ( ! class_exists('Wp_rem_Shortcode_Properties_with_Categories_Frontend') ) {
    ...
    class Wp_rem_Shortcode_Properties_with_Categories_Frontend {
        ...
        public function wp_rem_properties_filters_content($property_arg = '') {
			...
			if( $property_category == '' || $property_category == 'all' || $property_category == 'Array' ){
				$property_type_id = 0;
				...
				if( is_array($property_type_cats) && !empty($property_type_cats)){
					$property_category = implode(',', $property_type_cats);
				}
			}
            ...
            <div class="real-estate-property <?php echo esc_html($show_more_property); ?>">
                <?php
                $categories_properties_title = isset($atts['categories_properties_title']) ? $atts['categories_properties_title'] : '';
                ...
                $wp_rem_properties_categories_seperator = isset($atts['wp_rem_properties_with_categories_seperator_style']) ? $atts['wp_rem_properties_with_categories_seperator_style'] : '';
                ...
                $wp_rem_property_categories_element_title_color = isset($atts['wp_rem_property_categories_element_title_color']) ? $atts['wp_rem_property_categories_element_title_color'] : '';
                $wp_rem_property_categories_element_subtitle_color = isset($atts['wp_rem_property_categories_element_subtitle_color']) ? $atts['wp_rem_property_categories_element_subtitle_color'] : '';
                $element_title_color = '';
                if ( isset($wp_rem_property_categories_element_title_color) && $wp_rem_property_categories_element_title_color != '' ) {
                    $element_title_color = ' style="color:' . $wp_rem_property_categories_element_title_color . ' ! important"';
                }
                $element_subtitle_color = '';
                if ( isset($wp_rem_property_categories_element_subtitle_color) && $wp_rem_property_categories_element_subtitle_color != '' ) {
                    $element_subtitle_color = ' style="color:' . $wp_rem_property_categories_element_subtitle_color . ' ! important"';
                }
                ?>
                <div class="element-title <?php echo ($properties_filters_alagnment); ?>">
                    <?php if ( $categories_properties_title != '' ) { ?>
                        <h2<?php echo wp_rem_allow_special_char($element_title_color); ?>><?php echo esc_html($categories_properties_title); ?></h2>
                    <?php } ?>
                    ...
                    if ( isset($wp_rem_properties_categories_seperator) && ! empty($wp_rem_properties_categories_seperator) ) {
                        $wp_rem_cat_properties_seperator_html = '';
                        if ( $wp_rem_properties_categories_seperator == 'classic' ) {
                            $wp_rem_cat_properties_seperator_html .='<div class="classic-separator ' . $properties_filters_alagnment . '"><span></span></div>';
                        }
                        if ( $wp_rem_properties_categories_seperator == 'zigzag' ) {
                            $wp_rem_cat_properties_seperator_html .='<div class="separator-zigzag ' . $properties_filters_alagnment . '">
                                            <figure><img src="' . trailingslashit(wp_rem::plugin_url()) . 'assets/images/zigzag-img1.png" alt=""/></figure>
                                        </div>';
                        }
                        echo force_balance_tags($wp_rem_cat_properties_seperator_html);
                    }
                    ?>
                    <?php
