        ...
        <div class="row">
            ...
            if ($member_loop_obj->have_posts()) {
                ...
                while ($member_loop_obj->have_posts()) : $member_loop_obj->the_post();
                    ...
                    echo '<li itemprop="performer" itemscope="" itemtype="'. force_balance_tags($http_request).'schema.org/Person">';
                    echo '<a href="' . esc_url(get_the_permalink()) . '"><span itemprop="name">' . get_the_title() . '</span></a>';
                    echo '</li>';
                    $old_char = $new_char;
