...
//		
            ...
            $social_link = '<a href="' . admin_url('page=wp_rem_settings') . '" target="_blank">' . wp_rem_plugin_text_srt('wp_rem_property_packages_social_impressions_hint_social_network') . '</a>';
            $wp_rem_packages_fields[] = array(
