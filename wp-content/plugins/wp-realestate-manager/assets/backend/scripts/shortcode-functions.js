...
function SuccessLoader() {
    ...
    var loader = "<div class='loader'><i class='icon-spinner8 icon-spin'></i></div>"
...
jQuery(document).on("change", ".get-property-cats-by-type", function () {
    ...
    var rand_id = jQuery(this).data('id');
    $.ajax({
        type: "POST",
        url: wp_rem_globals.ajax_url,
        data: 'property_type='+property_type+'&property_element_rand_id='+rand_id+'&action=get_property_cats_by_type',
