                ...
                <div class="form-elements">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        if ( !class_exists('ZipArchive') ) {
                            $zip_missing = ' ziparchive-missing-link';
                        }
                        $wp_rem_opt_array = array(
                            ...
                            'cust_type' => 'submit',
                            'classes' => 'button-primary' . $zip_missing,
                        );
                        $wp_rem_form_fields->wp_rem_form_text_render($wp_rem_opt_array);
                        if ( !class_exists('ZipArchive') ) {
                            ?>
                            <br><br>
                            <div class="ziparchive-missing" style="display:none; color:red;"><?php echo esc_html(wp_rem_plugin_text_srt('wp_rem_property_ziparchive_missing')); ?></div>
                        <?php } ?>
                    </div>
                </div>
            </form>   
