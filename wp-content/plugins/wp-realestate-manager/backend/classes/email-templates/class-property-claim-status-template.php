...
/**
 * Received Property Claim Status Email Template
 *
 * @since 1.0
 * @package	Homevillas
 */
if (!class_exists('Wp_rem_property_claim_status_email_template')) {

    class Wp_rem_property_claim_status_email_template {
	...
	public function __construct() {
	    ...
	    $this->email_template_type = 'Property Claim Resolved';

	    $this->email_default_template = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"/></head><body style="margin: 0; padding: 0;"><div style="background-color: #eeeeef; padding: 50px 0;"><table style="max-width: 640px;" border="0" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e"><h1 style="color: #fff;">Property Claim Resolved</h1></td></tr><tr><td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td width="260" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding-bottom: 8px;">Hi, [CLAIM_USER_NAME]</td></tr><tr><td style="padding-bottom: 8px;">Your claim on property ( <a href="[PROPERTY_LINK]">[PROPERTY_TITLE]</a> ). has been resolved</td></tr><tr><td style="padding-bottom: 8px;">Property Name: [PROPERTY_TITLE]</td></tr><tr><td style="padding-bottom: 8px;">Email: [CLAIM_USER_EMAIL]</td></tr><tr><td style="padding-bottom: 8px;">Claim Status: [CLAIM_REASON]</td></tr></tbody></table></td></tr></table></td></tr><tr><td style="background-color: #ffffff; padding: 30px 30px 30px 30px;"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="font-family: Arial, sans-serif; font-size: 14px;">&reg; [SITE_NAME], 2017</td></tr></tbody></table></td></tr></tbody></table></div></body></html>';
	    ...
	    $this->email_template_index = 'claim-status-template';
	    ...
	    add_action('wp_rem_claim_status_email', array($this, 'wp_rem_claim_status_email_callback'), 10, 2);
	}

	public function wp_rem_claim_status_email_callback($user_data, $post_id) {
	    global $post_id;
	    $template = $this->get_template();
	    // checking email notification is enable/disable
	    if (isset($template['email_notification']) && $template['email_notification'] == 1) {
		// getting template fields
		$subject = (isset($template['subject']) && $template['subject'] != '' ) ? $template['subject'] : wp_rem_plugin_text_srt('wp_rem_property_claim_resolved');
		...
		Wp_rem_property_claim_status_email_template::$is_email_sent1 = $this->is_email_sent;
	    }
	}
    ...
    new Wp_rem_property_claim_status_email_template();
}
