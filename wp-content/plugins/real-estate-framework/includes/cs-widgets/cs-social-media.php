...
if (!class_exists('Rem_cs_Social_media')) {
    ...
    class Rem_cs_Social_media extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                    ...
                    wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_media'), // Name.
                    array('classname' => 'widget-text', 'description' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_media_desc'))
            );
        }
        ...
        function form($instance) {
            ...
            $cs_opt_array = array(
                'name' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_title_field'),
                'desc' => '',
            ...
            $cs_opt_array = array(
                'name' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_info_facebook_url'),
                'desc' => '',
                'hint_text' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_info_facebook_url_desc'),
                'echo' => true,
                'field_params' => array(
                    'std' => $facebook_url,
                    'id' => '',
            ...
            $cs_opt_array = array(
                'name' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_info_twitter_url'),
                'desc' => '',
                'hint_text' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_info_twitter_url_desc'),
                'echo' => true,
                'field_params' => array(
                    'std' => $twitter_url,
                    'id' => '',
            ...
            $cs_opt_array = array(
                'name' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_info_google_url'),
                'desc' => '',
                'hint_text' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_info_google_url_desc'),
                'echo' => true,
                'field_params' => array(
                    'std' => $google_url,
                    'id' => '',
                ...
                <ul>
                    ...
                    if ('' !== $facebook_url) {
                        ...
                        <li><a target="_blank" href="<?php echo esc_url($facebook_url); ?>" data-original-title="facebook"><i class="icon-facebook2"></i>
                                <strong><?php echo esc_html(number_format($fb)); ?></strong><span><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_media_facebook_followers'); ?></span></a></li>
                    <?php } if ('' !== $twitter_url) { ?>
                        <li><a target="_blank" href="<?php echo esc_url('https://twitter.com/search?q=' . $twitter_url . ''); ?>" data-original-title="twitter"><i class="icon-twitter2"></i><strong>
                                    ...
                                    ?>
                                </strong><span><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_media_twitter_followers'); ?></span></a></li>
                        <?php
                    } if ('' !== $google_url) {
                        $_gurl = '';
                        ...
                        <li><a target="_blank" href="<?php echo esc_url($_gurl); ?>" data-original-title="google"><i class=" icon-google4"></i>
                                <strong><?php echo esc_html(number_format($total_count)); ?></strong><span><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_social_media_google_followers'); ?></span></a></li>
                    <?php } ?>
                </ul>
                <?php
            }
    ...
    add_action('widgets_init', function() {
        register_widget('Rem_cs_Social_media');
    });
