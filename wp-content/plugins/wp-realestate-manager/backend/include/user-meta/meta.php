...
function extra_user_profile_fields( $user ) {
    ...
    $roles = $user->roles;
    if ( in_array( 'wp_rem_member', $roles ) || in_array( 'administrator', $roles ) ) {
    ?>
    <table class="form-table">
		...
		<tr class="user-company">
			...
			<td>
                ...
                $options = array( '' => wp_rem_plugin_text_srt( 'wp_rem_meta_select_user_company' ) );
                ...
                $wp_rem_form_fields->wp_rem_form_select_render( $wp_rem_opt_array );
                ?>
				<span class="compnay-error" style="display: none; color: red; font-style: italic;"><?php echo wp_rem_plugin_text_srt( 'wp_rem_meta_select_user_company_empty' ); ?></span>
			</td>
			<td><span style="color: #0073aa; font-style: italic;"><a href="<?php echo esc_url(admin_url('post-new.php?post_type=members')); ?>"><?php echo wp_rem_plugin_text_srt( 'wp_rem_meta_create_new_company' ); ?></a></span></td>
        </tr>
    </table> 
    <?php
    }
