    ...
    function wp_rem_cs_var_page_builder_contact_form($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                ...
                'wp_rem_cs_var_contact_form_title_color' => '',
                'wp_rem_cs_var_contact_form_subtitle_color' => '',
                 'wp_rem_var_contact_form_seperator_style'=> '',
            );
                ...
                <div class="cs-wrapp-class-<?php echo intval($wp_rem_cs_counter) ?>
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_cs_opt_array = array(
                                'name' => wp_rem_cs_var_frame_text_srt('wp_rem_var_title_color'),
                                'desc' => '',
                                'hint_text' => wp_rem_cs_var_frame_text_srt('wp_rem_var_title_color_hint'),
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_contact_form_title_color),
                                    'cust_name' => 'wp_rem_cs_var_contact_form_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_cs_opt_array = array(
                                'name' => wp_rem_cs_var_frame_text_srt('wp_rem_var_subtitle_color'),
                                'desc' => '',
                                'hint_text' => wp_rem_cs_var_frame_text_srt('wp_rem_var_subtitle_color_hint'),
                                'echo' => true,
                                'field_params' => array(
                                    'std' => wp_rem_cs_allow_special_char($wp_rem_cs_var_contact_form_subtitle_color),
                                    'cust_name' => 'wp_rem_cs_var_contact_form_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                    'name' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_element_title_seperator'),
                    'desc' => '',
                    'hint_text' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_element_title_seperator_hint'),
                    'echo' => true,
                    'field_params' => array(
                        'std' => $wp_rem_var_contact_form_seperator_style,
                        'id' => '',
                        'cust_name' => 'wp_rem_var_contact_form_seperator_style[]',
                        'classes' => 'chosen-select-no-single',
                        'options' => array(
                            '' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_element_title_seperator_none'),
                            'classic' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_element_title_seperator_classic'),
                            'zigzag' => wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_element_title_seperator_zigzag'),
                        ),
                        'return' => true,
                    ),
                );
    ...
    function wp_rem_cs_save_page_builder_data_contact_form_callback($args) {
        ...
        if ( $widget_type == "contact_form" || $widget_type == "cs_contact_form" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_cs_var_contact_form_title_color'][$counters['wp_rem_cs_counter_contact_us']]) && $data['wp_rem_cs_var_contact_form_title_color'][$counters['wp_rem_cs_counter_contact_us']] != '' ) {
                    $shortcode .= 'wp_rem_cs_var_contact_form_title_color="' . stripslashes(htmlspecialchars(($data['wp_rem_cs_var_contact_form_title_color'][$counters['wp_rem_cs_counter_contact_us']]), ENT_QUOTES)) . '" ';
                }
                if ( isset($data['wp_rem_cs_var_contact_form_subtitle_color'][$counters['wp_rem_cs_counter_contact_us']]) && $data['wp_rem_cs_var_contact_form_subtitle_color'][$counters['wp_rem_cs_counter_contact_us']] != '' ) {
                    $shortcode .= 'wp_rem_cs_var_contact_form_subtitle_color="' . stripslashes(htmlspecialchars(($data['wp_rem_cs_var_contact_form_subtitle_color'][$counters['wp_rem_cs_counter_contact_us']]), ENT_QUOTES)) . '" ';
                }
                ...
                if ( isset($data['wp_rem_var_contact_form_seperator_style'][$counters['wp_rem_cs_counter_contact_us']]) && $data['wp_rem_var_contact_form_seperator_style'][$counters['wp_rem_cs_counter_contact_us']] != '' ) {
                    $shortcode .= 'wp_rem_var_contact_form_seperator_style="' . stripslashes(htmlspecialchars(($data['wp_rem_var_contact_form_seperator_style'][$counters['wp_rem_cs_counter_contact_us']]), ENT_QUOTES)) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $shortcode, $data, $counters['wp_rem_cs_counter_contact_us'], array( 'responsive_atts' => true ));
