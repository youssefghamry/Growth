...
if ( ! class_exists('wp_rem_options_fields') ) {
    ...
    class wp_rem_options_fields {
        ...
        public function __construct() {
            ...
            add_action('wp_ajax_wp_rem_nearby_add_row_icon', array( $this, 'wp_rem_nearby_add_row_icon' ));
        }

        public function wp_rem_nearby_add_row_icon($cats = '') {
            $icon_rand_id = isset($_POST['icon_num']) ? $_POST['icon_num'] : rand(1000000, 90000000);
            $html = apply_filters('cs_icons_fields', '', 'wp_rem_map_markers_data_icon_' . $icon_rand_id, 'wp_rem_map_markers_data[icon]', 'default', 'wp_rem_map_markers_data[icon_group][]');
            $html .= '
			<script>
			chosen_selectionbox();
			</script>';
            ...
            foreach ( $wp_rem_setting_options as $value ) {
                ...
                switch ( $value['type'] ) {
                    ...
                    case 'fb_access_token' :
                        ...
                        $state = md5(get_home_url());
                        $redirecturl = urlencode(admin_url('admin.php?page=wp_rem_settings#tab-api-setting-show'));
                    ...
                    case "checkbox":
                        $std = '';
                        if ( isset($wp_rem_plugin_options) ) {
                            if ( isset($wp_rem_plugin_options['wp_rem_' . $value['id']]) && $wp_rem_plugin_options['wp_rem_' . $value['id']] != '' ) {
                    ...
                    case 'select_dashboard':
                        ...
                        $select_value = wp_rem_wpml_lang_page_id($select_value, 'page');
                    ...
                    case 'map_nearby_places':
                                    ...
                                    <div class="input-element">
                                        <div class="input-holder">
                                            <div class="nearby-img-icon-pare">
                                                ...
                                                <a href="javascript:void(0)" class="nearby-sel-img-icon-btn" data-id="<?php echo absint($icon_rand_id) ?>" data-img-txt="<?php echo wp_rem_plugin_text_srt('wp_rem_marker_opions_select_an_imag'); ?>" data-icon-txt="<?php echo wp_rem_plugin_text_srt('wp_rem_marker_opions_select_an_icon'); ?>"><?php echo wp_rem_plugin_text_srt('wp_rem_marker_opions_select_an_icon') ?></a>
                                                <?php
                                                $wp_rem_opt_array = array(
                                                    'std' => '',
                                                    'cust_id' => 'wp_rem_nearby_map_icon_type_' . absint($icon_rand_id),
                                                    'cust_name' => 'wp_rem_map_markers_data[icon_type][]',
                                                    'cust_type' => 'hidden',
                                                );
                                                $wp_rem_form_fields->wp_rem_form_text_render($wp_rem_opt_array);
                                                ?>
                                    ...
                                    <div class="input-element">
                                        <div class="input-holder">
                                            ...
                                            $near_locations = array(
                                                'accounting' => wp_rem_plugin_text_srt('wp_rem_marker_opions_accounting'),
                                                'airport' => wp_rem_plugin_text_srt('wp_rem_marker_opions_airport'),
                                                'amusement_park' => wp_rem_plugin_text_srt('wp_rem_marker_opions_amusement_park'),
                                                'aquarium' => wp_rem_plugin_text_srt('wp_rem_marker_opions_aquarium'),
                                                'art_gallery' => wp_rem_plugin_text_srt('wp_rem_marker_opions_art_gallery'),
                                                'atm' => wp_rem_plugin_text_srt('wp_rem_marker_opions_atm'),
                                                'bakery' => wp_rem_plugin_text_srt('wp_rem_marker_opions_bakery'),
                                                'bank' => wp_rem_plugin_text_srt('wp_rem_marker_opions_bank'),
                                                'bar' => wp_rem_plugin_text_srt('wp_rem_marker_opions_bar'),
                                                'beauty_salon' => wp_rem_plugin_text_srt('wp_rem_marker_opions_beauty_salon'),
                                                'bicycle_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_bicycle_store'),
                                                'book_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_book_store'),
                                                'bowling_alley' => wp_rem_plugin_text_srt('wp_rem_marker_opions_bowling_alley'),
                                                'bus_station' => wp_rem_plugin_text_srt('wp_rem_marker_opions_bus_station'),
                                                'cafe' => wp_rem_plugin_text_srt('wp_rem_marker_opions_cafe'),
                                                'campground' => wp_rem_plugin_text_srt('wp_rem_marker_opions_campground'),
                                                'car_dealer' => wp_rem_plugin_text_srt('wp_rem_marker_opions_car_dealer'),
                                                'car_rental' => wp_rem_plugin_text_srt('wp_rem_marker_opions_car_rental'),
                                                'car_repair' => wp_rem_plugin_text_srt('wp_rem_marker_opions_car_repair'),
                                                'car_wash' => wp_rem_plugin_text_srt('wp_rem_marker_opions_car_wash'),
                                                'casino' => wp_rem_plugin_text_srt('wp_rem_marker_opions_casino'),
                                                'cemetery' => wp_rem_plugin_text_srt('wp_rem_marker_opions_cemetery'),
                                                'church' => wp_rem_plugin_text_srt('wp_rem_marker_opions_church'),
                                                'city_hall' => wp_rem_plugin_text_srt('wp_rem_marker_opions_city_hall'),
                                                'clothing_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_clothing_store'),
                                                'convenience_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_convenience_store'),
                                                'courthouse' => wp_rem_plugin_text_srt('wp_rem_marker_opions_courthouse'),
                                                'dentist' => wp_rem_plugin_text_srt('wp_rem_marker_opions_dentist'),
                                                'department_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_department_store'),
                                                'doctor' => wp_rem_plugin_text_srt('wp_rem_marker_opions_doctor'),
                                                'electrician' => wp_rem_plugin_text_srt('wp_rem_marker_opions_electrician'),
                                                'electronics_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_electronics_store'),
                                                'embassy' => wp_rem_plugin_text_srt('wp_rem_marker_opions_embassy'),
                                                'establishment (deprecated)' => wp_rem_plugin_text_srt('wp_rem_marker_opions_establishment_deprecated'),
                                                'finance (deprecated)' => wp_rem_plugin_text_srt('wp_rem_marker_opions_finance_deprecated'),
                                                'fire_station' => wp_rem_plugin_text_srt('wp_rem_marker_opions_fire_station'),
                                                'florist' => wp_rem_plugin_text_srt('wp_rem_marker_opions_florist'),
                                                'food (deprecated)' => wp_rem_plugin_text_srt('wp_rem_marker_opions_food_deprecated'),
                                                'funeral_home' => wp_rem_plugin_text_srt('wp_rem_marker_opions_funeral_home'),
                                                'furniture_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_furniture_store'),
                                                'gas_station' => wp_rem_plugin_text_srt('wp_rem_marker_opions_gas_station'),
                                                'general_contractor (deprecated)' => wp_rem_plugin_text_srt('wp_rem_marker_opions_general_contractor_deprecated'),
                                                'grocery_or_supermarket (deprecated)' => wp_rem_plugin_text_srt('wp_rem_marker_opions_grocery_or_supermarket_deprecated'),
                                                'gym' => wp_rem_plugin_text_srt('wp_rem_marker_opions_gym'),
                                                'hair_care' => wp_rem_plugin_text_srt('wp_rem_marker_opions_hair_care'),
                                                'hardware_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_hardware_store'),
                                                'health (deprecated)' => wp_rem_plugin_text_srt('wp_rem_marker_opions_health_deprecated'),
                                                'hindu_temple' => wp_rem_plugin_text_srt('wp_rem_marker_opions_hindu_temple'),
                                                'home_goods_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_home_goods_store'),
                                                'hospital' => wp_rem_plugin_text_srt('wp_rem_marker_opions_hospital'),
                                                'insurance_agency' => wp_rem_plugin_text_srt('wp_rem_marker_opions_insurance_agency'),
                                                'jewelry_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_jewelry_store'),
                                                'laundry' => wp_rem_plugin_text_srt('wp_rem_marker_opions_laundry'),
                                                'lawyer' => wp_rem_plugin_text_srt('wp_rem_marker_opions_lawyer'),
                                                'library' => wp_rem_plugin_text_srt('wp_rem_marker_opions_library'),
                                                'liquor_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_liquor_store'),
                                                'local_government_office' => wp_rem_plugin_text_srt('wp_rem_marker_opions_local_government_office'),
                                                'locksmith' => wp_rem_plugin_text_srt('wp_rem_marker_opions_locksmith'),
                                                'lodging' => wp_rem_plugin_text_srt('wp_rem_marker_opions_lodging'),
                                                'meal_delivery' => wp_rem_plugin_text_srt('wp_rem_marker_opions_meal_delivery'),
                                                'meal_takeaway' => wp_rem_plugin_text_srt('wp_rem_marker_opions_meal_takeaway'),
                                                'mosque' => wp_rem_plugin_text_srt('wp_rem_marker_opions_mosque'),
                                                'movie_rental' => wp_rem_plugin_text_srt('wp_rem_marker_opions_movie_rental'),
                                                'movie_theater' => wp_rem_plugin_text_srt('wp_rem_marker_opions_movie_theater'),
                                                'moving_company' => wp_rem_plugin_text_srt('wp_rem_marker_opions_moving_company'),
                                                'museum' => wp_rem_plugin_text_srt('wp_rem_marker_opions_museum'),
                                                'night_club' => wp_rem_plugin_text_srt('wp_rem_marker_opions_night_club'),
                                                'painter' => wp_rem_plugin_text_srt('wp_rem_marker_opions_painter'),
                                                'park' => wp_rem_plugin_text_srt('wp_rem_marker_opions_park'),
                                                'parking' => wp_rem_plugin_text_srt('wp_rem_marker_opions_parking'),
                                                'pet_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_pet_store'),
                                                'pharmacy' => wp_rem_plugin_text_srt('wp_rem_marker_opions_pharmacy'),
                                                'physiotherapist' => wp_rem_plugin_text_srt('wp_rem_marker_opions_physiotherapist'),
                                                'place_of_worship (deprecated)' => wp_rem_plugin_text_srt('wp_rem_marker_opions_place_of_worship_deprecated'),
                                                'plumber' => wp_rem_plugin_text_srt('wp_rem_marker_opions_plumber'),
                                                'police' => wp_rem_plugin_text_srt('wp_rem_marker_opions_police'),
                                                'post_office' => wp_rem_plugin_text_srt('wp_rem_marker_opions_post_office'),
                                                'real_estate_agency' => wp_rem_plugin_text_srt('wp_rem_marker_opions_real_estate_agency'),
                                                'restaurant' => wp_rem_plugin_text_srt('wp_rem_marker_opions_restaurant'),
                                                'roofing_contractor' => wp_rem_plugin_text_srt('wp_rem_marker_opions_roofing_contractor'),
                                                'rv_park' => wp_rem_plugin_text_srt('wp_rem_marker_opions_rv_park'),
                                                'school' => wp_rem_plugin_text_srt('wp_rem_marker_opions_school'),
                                                'shoe_store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_shoe_store'),
                                                'shopping_mall' => wp_rem_plugin_text_srt('wp_rem_marker_opions_shopping_mall'),
                                                'spa' => wp_rem_plugin_text_srt('wp_rem_marker_opions_spa'),
                                                'stadium' => wp_rem_plugin_text_srt('wp_rem_marker_opions_stadium'),
                                                'storage' => wp_rem_plugin_text_srt('wp_rem_marker_opions_storage'),
                                                'store' => wp_rem_plugin_text_srt('wp_rem_marker_opions_store'),
                                                'subway_station' => wp_rem_plugin_text_srt('wp_rem_marker_opions_subway_station'),
                                                'synagogue' => wp_rem_plugin_text_srt('wp_rem_marker_opions_synagogue'),
                                                'taxi_stand' => wp_rem_plugin_text_srt('wp_rem_marker_opions_taxi_stand'),
                                                'train_station' => wp_rem_plugin_text_srt('wp_rem_marker_opions_train_station'),
                                                'transit_station' => wp_rem_plugin_text_srt('wp_rem_marker_opions_transit_station'),
                                                'travel_agency' => wp_rem_plugin_text_srt('wp_rem_marker_opions_travel_agency'),
                                                'university' => wp_rem_plugin_text_srt('wp_rem_marker_opions_university'),
                                                'veterinary_care' => wp_rem_plugin_text_srt('wp_rem_marker_opions_veterinary_care'),
                                                'zoo' => wp_rem_plugin_text_srt('wp_rem_marker_opions_zoo')
                                            );
                                ...
                                <ul class="wp-rem-list-layout">
                                    ...
                                    if ( is_array($wp_rem_map_markers_data) && sizeof($wp_rem_map_markers_data) > 0 && isset($wp_rem_map_markers_data['image']) ) {
                                        ...
                                        foreach ( $wp_rem_map_markers_data['image'] as $key => $row ) {
                                            ...
                                            $icon_value = isset($wp_rem_map_markers_data['icon'][$key]) ? $wp_rem_map_markers_data['icon'][$key] : '';
                                            $icon_group_value = isset($wp_rem_map_markers_data['icon_group'][$key]) ? $wp_rem_map_markers_data['icon_group'][$key] : 'default';
                                                        ...
                                                        <div class="input-holder">
                                                            <div class="nearby-img-icon-pare">
                                                                <div class="nearby-img-f" style="display: <?php echo ($map_icon_type == 'image') ? 'block' : 'none' ?>;">
                                                                    <?php
                                                                    $wp_rem_opt_array = array(
                                                                        'std' => wp_rem_cs_allow_special_char($image),
                                                                ...
                                                                <div class="nearby-icon-f" style="display: <?php echo ($map_icon_type == 'icon') ? 'block' : 'none' ?>;">
                                                                    <?php echo apply_filters('cs_icons_fields', $icon_value, 'wp_rem_map_markers_data_icon_' . $rand_id, 'wp_rem_map_markers_data[icon]', $icon_group_value, 'wp_rem_map_markers_data[icon_group][]'); ?>
                                                                </div>
                                                                <a href="javascript:void(0)" class="nearby-sel-img-icon-btn" data-id="<?php echo absint($rand_id) ?>" data-img-txt="<?php echo wp_rem_plugin_text_srt('wp_rem_marker_opions_select_an_imag'); ?>" data-icon-txt="<?php echo wp_rem_plugin_text_srt('wp_rem_marker_opions_select_an_icon'); ?>"><?php echo ($map_icon_type == 'icon' ? wp_rem_plugin_text_srt('wp_rem_marker_opions_select_an_imag') : wp_rem_plugin_text_srt('wp_rem_marker_opions_select_an_icon')) ?></a>
                                                                <?php
                                                                $wp_rem_opt_array = array(
                                                                    'std' => $map_icon_type,
                                                                    'cust_id' => 'wp_rem_nearby_map_icon_type_' . absint($rand_id),
                                                                    'cust_name' => 'wp_rem_map_markers_data[icon_type][]',
                                                                    'cust_type' => 'hidden',
                                                                );
                                                                $wp_rem_form_fields->wp_rem_form_text_render($wp_rem_opt_array);
                                ...
                                <ul class="wp-rem-list-button-ul">
                                    <li class="wp-rem-list-button">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <!--For Simple Input Element-->
                                          <div class="input-element">
                                                <a href="javascript:void(0);" id="click-more" class="wp-rem-add-more cntrl-add-new-row" onclick="duplicate1('<?php  echo absint($icon_rand_id) ?>')"><?php  echo wp_rem_plugin_text_srt('wp_rem_property_type_meta_feature_add_row'); ?></a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <script type="text/javascript">
                            ...
                            function duplicate1(icon_num) {
                                ...
                                $('#nearby-icon-apender-' + new_icon_num).html('<img src="<?php echo wp_rem::plugin_url() . 'assets/backend/images/ajax-loader.gif' ?>" alt="" />');
                                $.ajax({
                                    url: '<?php echo admin_url('admin-ajax.php') ?>',
                                    method: "POST",
                                    data: {
                                        icon_num: new_icon_num,
                                        action: 'wp_rem_nearby_add_row_icon'
                                    },
                                    dataType: "json"
                                }).done(function (response) {
										...
										if(address != ""){
											geocoder.geocode( { \'address\': address}, function(results, status) {
												if (status == google.maps.GeocoderStatus.OK) {
													...
													console.log("Address is not correct.>plugin-option-fields->line#2033");
													return false;
												}
											});
										} else {
                    ...
                    case 'review_flags':
                        global $post, $wp_rem_form_fields, $wp_rem_html_fields, $wp_rem_plugin_static_text, $wp_rem_plugin_options;
                        $fixed_price_opt = isset($wp_rem_plugin_options['review_flag_opts']) ? $wp_rem_plugin_options['review_flag_opts'] : '';
                        ob_start();
                        ?>
                        <div class="wp-rem-list-wrap">
                            <ul class="wp-rem-list-layout">
                            ...
                            <ul class="wp-rem-list-button-ul">
                                <li class="wp-rem-list-button">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <!--For Simple Input Element-->
                                        <div class="input-element">
                                            <a href="javascript:void(0);" id="click-more" class="wp-rem-add-more cntrl-add-new-row add-review-type-opt"><?php echo wp_rem_plugin_text_srt('wp_rem_options_add_more'); ?></a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    case 'member_types':
                        ...
                        <script type="text/javascript">
                            ...
                            function wp_rem_check_plugin_field_avial(counter, ajaxurl) {
                                ...
                                jQuery('.output' + counter).html('<span class="loader-spinner"><i class="icon-spinner8"></i></span>');
                                jQuery.ajax({
                                    type: "POST",
                                    url: ajaxurl,
                                    data: dataString,
				...
				$fields_content = apply_filters( 'wp_rem_property_fields_settings_fields', '', $value );
