...
if ( ! class_exists('Wp_rem_Shortcode_Split_Map_Frontend') ) {
    ...
    class Wp_rem_Shortcode_Split_Map_Frontend {
        ...
        public function wp_rem_split_map_shortcode_callback($atts, $content = "") {
            ...
            ?> 
            <div class="wp-rem-property-content wp-rem-split-map-wrap split-map-<?php
            echo esc_html($wp_rem_map_position);
            echo esc_html($wp_rem_map_fixed);
            ?>" id="wp-rem-property-content-<?php echo esc_html($property_short_counter); ?>">
                 <?php
            ...
            if ( isset($search_title) && $search_title != '' ) {
                ...
                $query_2 = get_posts(array(
                    ...
                    'meta_query' => array(
                        'relation' => 'OR',
                        /*
                         * search_keywords_field will search the categories and property type
                        ...
                        /*
                         * This is the alternative for the above commented script
                         * @To make the above script work you need to remove this one and uncomment the above one.
                         */
                        array(
...
// top categories
            ...
            <form id="frm_property_arg<?php echo absint($property_short_counter); ?>">
                ...
                <?php
                echo '<div class="row">';
                if ( ( $search_box_sidebar == 'yes' && isset($property_view) && $property_view != 'map' ) ) {  // if sidebar on from element
                ...
                <div class="<?php echo esc_html($content_columns); ?>">
                    ...
                    <div class="real-estate-property-content real-estate-dev-property-content" id="wp-rem-data-property-content-<?php echo esc_html($property_short_counter); ?>" data-id="<?php echo esc_html($property_short_counter); ?>">
                        ...
                        $wp_rem_split_map_seperator_style = isset($atts['wp_rem_split_map_seperator_style']) ? $atts['wp_rem_split_map_seperator_style'] : '';
                        $wp_rem_split_map_element_title_color = isset($atts['wp_rem_split_map_element_title_color']) ? $atts['wp_rem_split_map_element_title_color'] : '';
                        $wp_rem_split_map_element_subtitle_color = isset($atts['wp_rem_split_map_element_subtitle_color']) ? $atts['wp_rem_split_map_element_subtitle_color'] : '';
                        $element_title_color = '';
                        if ( isset($wp_rem_split_map_element_title_color) && $wp_rem_split_map_element_title_color != '' ) {
                            $element_title_color = ' style="color:' . $wp_rem_split_map_element_title_color . ' ! important"';
                        }
                        $element_subtitle_color = '';
                        if ( isset($wp_rem_split_map_element_subtitle_color) && $wp_rem_split_map_element_subtitle_color != '' ) {
                            $element_subtitle_color = ' style="color:' . $wp_rem_split_map_element_subtitle_color . ' ! important"';
                        }
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="element-title <?php echo ($split_map_title_alignment); ?>">
                                    ...
                                    if ( $split_map_title != '' || $split_map_subtitle != '' ) {
                                        if ( $split_map_title != '' ) {
                                            ?>
                                            <h2<?php echo wp_rem_allow_special_char($element_title_color); ?>><?php echo esc_html($split_map_title); ?></h2>
                                            <?php
                                        }
                                        if ( $split_map_subtitle != '' ) {
                                            ?>
                                            <p<?php echo wp_rem_allow_special_char($element_subtitle_color); ?>><?php echo esc_html($split_map_subtitle); ?></p>
                                            <?php
                                        }
                                        if ( isset($wp_rem_split_map_seperator_style) && ! empty($wp_rem_split_map_seperator_style) ) {
                                            $wp_rem_split_properties_seperator_html = '';
                                            if ( $wp_rem_split_map_seperator_style == 'classic' ) {
                                                $wp_rem_split_properties_seperator_html .='<div class="classic-separator ' . $split_map_title_alignment . '"><span></span></div>';
                                            }
                                            if ( $wp_rem_split_map_seperator_style == 'zigzag' ) {
                                                $wp_rem_split_properties_seperator_html .='<div class="separator-zigzag ' . $split_map_title_alignment . '">
                                            <figure><img src="' . trailingslashit(wp_rem::plugin_url()) . 'assets/images/zigzag-img1.png" alt=""/></figure>
                                        </div>';
                                            }
                                            echo force_balance_tags($wp_rem_split_properties_seperator_html);
                                        }
                                    }
