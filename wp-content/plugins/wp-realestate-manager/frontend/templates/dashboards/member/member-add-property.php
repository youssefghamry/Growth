...
if ( ! class_exists('wp_rem_member_property_actions') ) {
    ...
    class wp_rem_member_property_actions {
         ...
         * @return markup
         */
        public function property_info_field_show($info_meta = array(), $index = '') {
        ...
        public function property_info($html = '') {
            ...
            if ( $get_property_id != '' && $get_property_id != 0 && $this->is_member_property($get_property_id) ) {
                ...
                // expired post
                else if ( strtotime($property_post_expiry_date) >= strtotime($property_post_on_date) && strtotime($property_post_expiry_date) <= strtotime(current_time('d-m-Y', 1)) ) {
                    $html .= '
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="property-info-sec">
						<div class="field-holder">
                ...
                // awaiting approval OR active Property
                else if ( strtotime($property_post_expiry_date) > strtotime(current_time('d-m-Y', 1)) && $property_status != 'pending' ) {
                    ...
                    //$html .= $this->property_info_field_show($trans_all_meta, 10);
                    //$html .= $this->property_info_field_show($trans_all_meta, 11);
        ...
        public function property_tags($type_id = '', $wp_rem_id = '') {
			...
			$type_id = wp_rem_wpml_lang_page_id( $type_id, 'property-type' );
        ...
        public function property_meta_save() {
            ...
            if ( $property_id != '' && $property_id != 0 && $this->is_form_submit() ) {
                ...
                if ( ! $is_updating ) {
                    ...
                    update_post_meta($property_id, 'wp_rem_property_posted', strtotime(current_time('d-m-Y', 1  )));
        ...
        public function wp_rem_property_add_transaction($type = '', $property_id = 0, $package_id = 0, $member_id = '') {
            ...
            if ( isset($trans_id) && $type != '' && $trans_id > 0 ) {
                ...
                if ( $pay_process ) {
                    ...
                    $wp_rem_payment_page_link = $wp_rem_payment_page != '' ? wp_rem_wpml_lang_page_permalink($wp_rem_payment_page, 'page') : '';
