...
if ( ! function_exists('create_plugin_options') ) {
	 ...
	 */
	function create_plugin_options($wp_rem_setting_options = array()) {

		if ( ! is_array($wp_rem_setting_options) ) {
...
if ( ! function_exists('wp_rem_properties_shortcode_admin_fields_callback') ) {
	 ...
	 * 'Email me property like these' button 
	 * 'Property Options Shortcode Element Settings'
	 */
	function wp_rem_properties_shortcode_admin_fields_callback($attrs = array()) {
