...
if ( ! function_exists('wp_rem_settings_options_page') ) {
    ...
    function wp_rem_settings_options_page() {
        ...
        apply_filters('wp_rem_translate_options_admin', $wp_rem_plugin_options );
...
if ( ! function_exists('wp_rem_settings_option') ) {
    ...
    function wp_rem_settings_option() {
		...
		$wp_rem_setting_options[] = array(
            'name' => wp_rem_plugin_text_srt('wp_rem_reviews_property_review_flag_options'),
            'id' => 'review-flag-options',
            'std' => wp_rem_plugin_text_srt('wp_rem_reviews_property_review_flag_options'),
            'type' => 'section',
            'options' => ''
        );
        $wp_rem_setting_options[] = array(
       ...
       // );
		$wp_rem_setting_options[] = array(
            "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_term_condition_page'),
            "desc" => '',
            "hint_text" => '',
            "label_desc" => wp_rem_plugin_text_srt('wp_rem_plugin_options_term_condition_page_hint'),
            "id" => "wp_rem_term_condition_list_page",
            "std" => '',
            "type" => "select_dashboard",
            'custom_page_select' => true,
            "options" => ''
		...
		$wp_rem_setting_options[] = array(
            "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_privacy_policy_page'),
            "desc" => '',
            "hint_text" => '',
            "label_desc" => wp_rem_plugin_text_srt('wp_rem_plugin_options_term_condition_page_hint'),
            "id" => "wp_rem_privacy_policy_list_page",
            "std" => '',
            "type" => "select_dashboard",
            'custom_page_select' => true,
            "options" => ''
...
$wp_rem_setting_options[] = array(
            "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_select_cookies_page'),
            "desc" => '',
            "hint_text" => '',
            "label_desc" => wp_rem_plugin_text_srt('wp_rem_plugin_options_select_cookies_page_hit'),
            "id" => "wp_rem_cookies_list_page",
            "std" => '',
            "type" => "select_dashboard",
            'custom_page_select' => true,
            "options" => ''
		...
		$wp_rem_setting_options[] = array( 
			"name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_user_reg_package'),
            "id" => '',
            "std" => wp_rem_plugin_text_srt('wp_rem_plugin_options_user_reg_package'),
            "type" => "section",
            "options" => ""
        );

        $wp_rem_setting_options[] = array(
            "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_user_reg_package_asign'),
            "desc" => '',
            "hint_text" => wp_rem_plugin_text_srt('wp_rem_plugin_options_user_reg_package_asign_hint'),
		...
		$free_packages = array('' => wp_rem_plugin_text_srt('wp_rem_plugin_options_user_reg_package_select'));
		$p_args = array(
			'post_type' => 'packages',
			'post_status' => 'publish',
			'posts_per_page' => -1,
        ...
        $wp_rem_setting_options[] = array(
            "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_user_reg_package_txt'),
            "hint_text" => '',
            "desc" => wp_rem_plugin_text_srt('wp_rem_plugin_options_user_reg_package_txt_hint'),
        ...
        $wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_property_page_slug'),
            "id" => "tab-slug-options",
            "std" => wp_rem_plugin_text_srt('wp_rem_plugin_options_property_page_slug'),
            "type" => "section",
            "options" => ""
        );

        $wp_rem_setting_options[] = array(
            "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_property_page_slug_option'),
            "desc" => "",
            "id" => "slug_page",
            'hint_text' => 'Slug of Property Detail Page',
            "std" => '',
            "type" => "text",
        );
        ...
        $wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_options_property_detail_views'),
            ...
            "options" => array(
                ...
                'detail_view5' => wp_rem_plugin_text_srt('wp_rem_view5'),
            )
        );
		
		$single_property_options = array(
			'top_map' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_top_map'),
			'top_slider' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_top_slider'),
			'top_gallery_map' => wp_rem_plugin_text_srt('wp_rem_single_options_top_gallery_with_map'),
			'sticky_navigation' => wp_rem_plugin_text_srt('wp_rem_list_meta_sticky'),
			'content_gallery' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_content_gallery'),
			'social_networks' => wp_rem_plugin_text_srt('wp_rem_user_meta_social_networks'),
			'bottom_member_info' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_content_bottom_member_info'),
			'sidebar_map' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_sidebar_map'),
			'sidebar_gallery' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_sidebar_gallery'),
			'sidebar_member_info' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_sidebar_member_info'),
			'sidebar_contact_info' => wp_rem_plugin_text_srt('wp_rem_single_options_sidebar_contact_info'),
			'sidebar_mortgage_calculator' => wp_rem_plugin_text_srt('wp_rem_options_property_detail_sidebar_mortgage_calculator'),
		);
		
		$wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_single_options_view_1_heading'),
            "id" => "detail_view1",
            "std" => wp_rem_plugin_text_srt('wp_rem_single_options_view_1_heading'),
            "type" => "section",
            "options" => "",
        );
		if( isset( $single_property_options )){
			$exclude_view_1_options = array( 'top_map', 'top_slider', 'top_gallery_map', 'sticky_navigation' );
			foreach( $single_property_options as $key => $val ){
				if( !in_array($key, $exclude_view_1_options)){
					$wp_rem_setting_options[] = array( 
						"name" => $val,
						"desc" => "",
						"hint_text" => '',
						"id" => "detail_view1_". $key,
						"std" => "on",
						"type" => "checkbox",
						"options" => $on_off_option
					);
		...
		$wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_single_options_view_2_heading'),
            "id" => "detail_view2",
            "std" => wp_rem_plugin_text_srt('wp_rem_single_options_view_2_heading'),
            "type" => "section",
            "options" => ""
        );
		if( isset( $single_property_options )){
		...
		$wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_single_options_view_3_heading'),
            "id" => "detail_view3",
            "std" => wp_rem_plugin_text_srt('wp_rem_single_options_view_3_heading'),
            "type" => "section",
            "options" => ""
        );
		if( isset( $single_property_options )){
			$exclude_view_1_options = array( 'top_gallery_map', 'content_gallery' );
			foreach( $single_property_options as $key => $val ){
				if( !in_array($key, $exclude_view_1_options)){
					$wp_rem_setting_options[] = array( 
						"name" => $val,
		...
		$wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_single_options_view_4_heading'),
            "id" => "detail_view4",
            "std" => wp_rem_plugin_text_srt('wp_rem_single_options_view_4_heading'),
            "type" => "section",
            "options" => ""
        );
		if( isset( $single_property_options )){
		...
		$wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_single_options_view_5_heading'),
            "id" => "detail_view5",
            "std" => wp_rem_plugin_text_srt('wp_rem_single_options_view_5_heading'),
            "type" => "section",
            "options" => ""
        );
		if( isset( $single_property_options )){
			$exclude_view_1_options = array( 'top_map', 'top_slider', 'content_gallery', 'social_networks' );
			foreach( $single_property_options as $key => $val ){
				if( !in_array($key, $exclude_view_1_options)){
					$wp_rem_setting_options[] = array( 
						"name" => $val,
        ...
        $wp_rem_setting_options[] = array( "name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_distance_measure_by'),
            "desc" => "",
            "hint_text" => '',
            "label_desc" => '',
            ...
            'classes' => 'chosen-select-no-single',
            "options" => array(
                'km' => wp_rem_plugin_text_srt('wp_rem_plugin_options_km'),
                'miles' => wp_rem_plugin_text_srt('wp_rem_plugin_options_miles'),
            )
        );
		...
		$wp_rem_setting_options[] = array(
			'name' => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_stings'),
			'id' => 'property-success-settings',
			'std' => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_stings'),
			'type' => 'section',
			'options' => ''
		);

		$wp_rem_setting_options[] = array(
			"name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_img'),
			"desc" => "",
			"hint_text" => '',
			"id" => "property_success_image",
			"std" => "",
			"type" => "upload"
		);

		$wp_rem_setting_options[] = array(
			"name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg'),
			"desc" => "",
			"hint_text" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_hint'),
			"id" => "property_success_message",
			"std" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_default'),
			"type" => "text",
		);
		
		$wp_rem_setting_options[] = array(
			"name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_rev_msg'),
			"desc" => "",
			"hint_text" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_rev_msg_hint'),
			"id" => "property_approval_message",
			"std" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_review'),
			"type" => "text",
		);

		$wp_rem_setting_options[] = array(
			"name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_phn'),
			"desc" => "",
			"hint_text" => '',
			"id" => "property_success_phone",
			"std" => "",
			"type" => "text",
		);

		$wp_rem_setting_options[] = array(
			"name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_fax'),
			"desc" => "",
			"hint_text" => '',
			"id" => "property_success_fax",
			"std" => "",
			"type" => "text",
		);

		$wp_rem_setting_options[] = array(
			"name" => wp_rem_plugin_text_srt('wp_rem_plugin_options_success_msg_email'),
			"desc" => "",
			"hint_text" => '',
			"id" => "property_success_email",
			"std" => "",
			"type" => "text",
		);
		...
		$wp_rem_setting_options = apply_filters( 'wp_rem_property_fields_settings_tab', $wp_rem_setting_options );
