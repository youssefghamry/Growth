...
class WP_Property_Hunt_Employer_UI {
    ...
    public function wp_rem_member_permissions_callback($permissions = array()) {
                            ...
                            <ul class="feature-properties">
                                ...
                                while ( $property_alerts->have_posts() ) :
                                    ...
                                    foreach ( $frequencies as $key => $frequency ) {
                                        $frequency_val = get_post_meta($post->ID, 'wp_rem_frequency_' . $key, true);
                                    ...
                                    <li class="holder-<?php echo intval($post->ID); ?>">
                                        <div class="company-detail-inner">
                                            <h6><a href="<?php echo wp_rem_wpml_lang_page_permalink($search_list_page, 'page') . '?' ?>"><?php echo esc_html($wp_rem_name); ?></a></h6><br>
