    ...
    function wp_rem_cs_var_page_builder_wp_rem_register($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                ...
                'wp_rem_register_element_title_color' => '',
                'wp_rem_register_element_subtitle_color' => '',
            );
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_register_element_title_color,
                                    'cust_name' => 'wp_rem_register_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_register_element_subtitle_color,
                                    'cust_name' => 'wp_rem_register_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
    ...
    function wp_rem_cs_save_page_builder_data_wp_rem_register_callback($args) {
        ...
        if ( $widget_type == "wp_rem_register" || $widget_type == "cs_wp_rem_register" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_register_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_register']]) && $data['wp_rem_register_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_register']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_register .= 'wp_rem_register_element_title_color="' . htmlspecialchars($data['wp_rem_register_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_register']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_register_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_register']]) && $data['wp_rem_register_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_register']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_register .= 'wp_rem_register_element_subtitle_color="' . htmlspecialchars($data['wp_rem_register_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_register']], ENT_QUOTES) . '" ';
                }
                $wp_rem_cs_bareber_wp_rem_register .= ']';
