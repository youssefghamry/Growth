    ...
    <div class="real-estate-property" id="real-estate-property-<?php echo absint($property_short_counter) ?>">
        <div class="row">
                        ...
                        <div class="<?php echo esc_html($main_class); ?> <?php echo esc_html($pro_is_compare); ?> list-top-category advance-grid" itemscope itemtype="<?php echo force_balance_tags($http_request); ?>schema.org/Product">
                            <div class="img-holder">
                                <figure>
                                    ...
                                    <figcaption>
                                        ...
                                        if ( $property_view == 'grid' ) {
                                            echo fetch_property_open_house_grid_view_callback($property_id, $atts);
                                        }
                                        ?>
                                        <div class="caption-inner">
                                            <ul class="rem-property-options">
                                                ...
                                                do_action('wp_rem_property_compare', $property_id, $compare_property_switch, 'no', '<li class="property-compare-opt"><div class="option-holder">', '</div></li>');
                                                if ( $property_view == 'grid' ) {
                                                    $figcaption_div = true;
                            ...
                            <?php if ( $property_view != 'grid' ) { ?>
                                <div class="text-holder">
                                    ...
                                    $open_house_data = apply_filters('fetch_property_open_house', $property_id, $atts);
                                ...
                                <div class="text-holder">
                                    ...
                                    if ( isset($title__) && ! empty($title__) ) {
                                        ?>
                                        <div class="post-title">
                                            <h4 itemprop="name"><a href="<?php echo esc_url(get_permalink($property_id)); ?>"><?php echo esc_html(wp_trim_words($title__, $wp_rem_properties_title_limit)) ?></a></h4>
                                        </div>
                                    <?php } ?>
                                ...
                                <?php if ( (isset($property_notes_switch) && $property_notes_switch == 'yes') || (isset($property_hide_switch) && $property_hide_switch == 'yes') ) { ?>
            ...
            while ( $property_loop_obj->have_posts() ) : $property_loop_obj->the_post();
                ...
                ?>
                <div class="property-row <?php echo esc_html($columns_class); ?><?php echo wp_rem_is_property_sold($property_id) ? ' property-is-sold' : '' ?>">
                    <div class="<?php echo esc_html($main_class); ?> <?php echo esc_html($pro_is_compare); ?> advance-grid" itemscope itemtype="<?php echo force_balance_tags($http_request); ?>schema.org/Product">
                        <div class="img-holder">
                            <figure>
                                <a href="<?php the_permalink(); ?>">
                                    <?php
                        ...
                        <?php if ( $property_view != 'grid' ) { ?>
                            <div class="text-holder">
                                ...
                                $member_image = wp_get_attachment_image_src($member_image_id, 'thumbnail');
                                if ( $member_image == '' || FALSE == get_post_status($wp_rem_property_member) ) {
                                    $member_image   = is_array($member_image)? $member_image : array();
                                    $member_image[0] = esc_url(wp_rem::plugin_url() . 'assets/frontend/images/member-no-image.jpg');
                                }
                                if ( $member_image != '' && get_post_status($wp_rem_property_member) ) {
                                    ?>
