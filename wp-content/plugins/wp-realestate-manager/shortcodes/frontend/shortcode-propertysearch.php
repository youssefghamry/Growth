...
if ( ! class_exists('Wp_rem_Shortcode_Propertiesearch_Frontend') ) {
    ...
    class Wp_rem_Shortcode_Propertiesearch_Frontend {
        ...
        public function wp_rem_propertysearch_shortcode_callback($atts, $content = "") {
            $property_short_counter = isset($atts['property_counter']) && $atts['property_counter'] != '' ? ( $atts['property_counter'] ) : rand(123, 9999); // for shortcode counters
            ob_start();
            ...
            $element_title_color = isset($atts['wp_rem_property_search_element_title_color']) ? $atts['wp_rem_property_search_element_title_color'] : '';
            $element_subtitle_color = isset($atts['wp_rem_property_search_element_subtitle_color']) ? $atts['wp_rem_property_search_element_subtitle_color'] : '';

            $wp_rem_property_search_seperator_style = isset($atts['wp_rem_property_search_seperator_style']) ? $atts['wp_rem_property_search_seperator_style'] : '';
            ...
            if ( $propertysearch_view == 'list' ) {
                ...
                <div class="main-search" id="wp-rem-property-content-<?php echo esc_html($property_short_counter); ?>">
                    ...
                    $wp_rem_element_structure .= wp_rem_plugin_title_sub_align($propertysearch_title, $propertysearch_subtitle, $propertysearch_alignment, $element_title_color, $wp_rem_property_search_seperator_style, $element_subtitle_color);
                ...
                <?php
            } elseif ( $propertysearch_view == 'modern' ) {
                $wp_rem_element_structure = '';
                $wp_rem_element_structure .= wp_rem_plugin_title_sub_align($propertysearch_title, $propertysearch_subtitle, $propertysearch_alignment, $element_title_color, $wp_rem_property_search_seperator_style, $element_subtitle_color);
                echo force_balance_tags($wp_rem_element_structure);
                ?>
            ...
            <?php } elseif ( $propertysearch_view == 'modern_v4' ) {
                ?>
                <div class="wp-rem-property-content main-search dark-search" id="wp-rem-property-content-<?php echo esc_html($property_short_counter); ?>" <?php echo wp_rem_allow_special_char($search_backg_color_style); ?>>
                    <?php if ( ! empty($propertysearch_title) ) { ?>
                        <p class="search-heading" <?php echo wp_rem_allow_special_char($element_color_title); ?>>
                            <?php echo esc_html($propertysearch_title); ?>
                        </p>
            ...
            <?php
            } elseif ( $propertysearch_view == 'simple' ) {
                $wp_rem_element_structure = '';
                $wp_rem_element_structure .= wp_rem_plugin_title_sub_align($propertysearch_title, $propertysearch_subtitle, $propertysearch_alignment, $element_title_color, $wp_rem_property_search_seperator_style, $element_subtitle_color);
                echo force_balance_tags($wp_rem_element_structure);
                ?>
            ...
            <?php } elseif ( $propertysearch_view == 'fancy_v4' ) { ?>
                <div class="wp-rem-property-content main-search fancy v3 plain" id="wp-rem-property-content-<?php echo esc_html($property_short_counter); ?>" <?php echo wp_rem_allow_special_char($search_backg_color_style); ?>>
                    <?php
                    $wp_rem_element_structure = '';
                    $wp_rem_element_structure .= wp_rem_plugin_title_sub_align($propertysearch_title, $propertysearch_subtitle, $propertysearch_alignment, $element_title_color, $wp_rem_property_search_seperator_style, $element_subtitle_color);
                    echo force_balance_tags($wp_rem_element_structure);
        ...
        public function wp_rem_propertysearch_content($property_arg = '') {
            ...
            } else if ( $propertysearch_view == 'modern_v4' ) {
                wp_rem_get_template_part('propertysearch', 'modern-v4-filters', 'propertysearch');
            ...
            } else if ( $propertysearch_view == 'fancy_v4' ) {
                wp_rem_get_template_part('propertysearch', 'fance-v4-filters', 'propertysearch');
            } else {
