 ...
 *
 */
global $post, $wp_rem_plugin_options, $wp_rem_theme_options, $Wp_rem_Captcha, $wp_rem_form_fields_frontend, $wp_rem_post_property_types, $wp_rem_author_info;
$post_id = $post->ID;
...
$wp_rem_facebook = get_post_meta($post_id, 'wp_rem_facebook', true);
$wp_rem_google_plus = get_post_meta($post_id, 'wp_rem_google_plus', true);
$wp_rem_twitter = get_post_meta($post_id, 'wp_rem_twitter', true);
$wp_rem_linkedIn = get_post_meta($post_id, 'wp_rem_linkedIn', true);
...
if ( isset($wp_rem_user_status) && $wp_rem_user_status == 'active' ) {
            ...
            <div itemprop="performer" itemscope="" itemtype="<?php echo force_balance_tags($http_request); ?>schema.org/Person"  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="member-info">
                    ...
                    <div class="text-holder">
                        ...
                        <?php if ( $wp_rem_facebook != '' || $wp_rem_google_plus != '' || $wp_rem_twitter != '' || $wp_rem_linkedIn != '' ) { ?>
                            <div class="social-area"> 
                                <ul class="social-media">
                                    <?php if ( $wp_rem_facebook != '' ) { ?>
                                        <li><a href="<?php echo esc_url($wp_rem_facebook); ?>" title="<?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_facebook'); ?>" target="_blank"><i class="icon-facebook5"></i></a></li>
                                    <?php }if ( $wp_rem_google_plus != '' ) { ?>
                                        <li><a href="<?php echo esc_url($wp_rem_google_plus); ?>" title="<?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_google_plus'); ?>" target="_blank"><i class="icon-twitter4"></i></a></li>
                                    <?php }if ( $wp_rem_twitter != '' ) { ?>
                                        <li><a href="<?php echo esc_url($wp_rem_twitter); ?>" title="<?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_twitter'); ?>" target="_blank"><i class="icon-google-plus"></i></a></li>
                                    <?php } if ( $wp_rem_linkedIn != '' ) { ?>
                                        <li><a href="<?php echo esc_url($wp_rem_linkedIn); ?>" title="<?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_linkedIn'); ?>" target="_blank"><i class="icon-linkedin4"></i></a></li>
                                    <?php } ?>
                                </ul>
                        ...
                        <ul class="info-list">
                            <?php if ( isset($wp_rem_post_loc_address_member) && $wp_rem_post_loc_address_member != '' ) { ?>
                                <li><i class="icon-location-pin2"></i> <a itemprop="address" href="#" class="branch-address-link" data-lat="<?php echo $wp_rem_post_loc_latitude_member; ?>" data-lng="<?php echo $wp_rem_post_loc_longitude_member; ?>"><?php echo esc_html($wp_rem_post_loc_address_member); ?></a></li>
                            <?php } ?>
                            <?php
                            if ( isset($wp_rem_phone_number) && $wp_rem_phone_number != '' ) {
                                $all_data = '';
                                $all_data = $wp_rem_author_info->wp_rem_member_member_phone_num($wp_rem_phone_number, 'icon-mobile2', '<li>', '</li>', 'itemprop="telephone"');
                    ...
                    <div class="tab-content">
                        <?php if ( isset($wp_rem_biography) && $wp_rem_biography != '' ) { ?>
                            <div id="overview_tab" class="tab-pane fade in active">
                                <p itemprop="disambiguatingDescription"><?php echo force_balance_tags(str_replace("<br/>", '</p><p>', str_replace("<br />", '</p><p>', nl2br($wp_rem_biography)))); ?></p>
                            </div>
                        <?php } ?>
                                        ...
                                        <li>
                                            <div class="member-data">
                                                ...
                                                if ( isset($branche_phone) && $branche_phone != '' ) {
                                                    $all_data = '';
                                                    $all_data = $wp_rem_author_info->wp_rem_member_member_phone_num($branche_phone, 'icon-phone2', '<span class="member-phone">', '</span>');
                                                    echo force_balance_tags($all_data);
                                                    ?>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="member-data">
                                                        ...
                                                        if ( isset($phone_number) && $phone_number != '' ) {
                                                            $all_data = '';
                                                            $all_data = $wp_rem_author_info->wp_rem_member_member_phone_num($phone_number, 'icon-phone2', '<span class="member-phone">', '</span>');
                                                            echo force_balance_tags($all_data);
                                                        }
                                                        ?>
                                                    </div>
                                    ...
                                    <div class="property-medium">
                                                ...
                                                <figcaption>
                                                    ...
                                                    <div class="caption-inner">
                                                        <ul class="rem-property-options">
                                                            ...
                                                            if ( $property_video_url != '' && $wp_rem_video_element_switch == 'on' ) {
                                                                ?>
                                                            ...
                                                            <?php } ?>
                                                            <?php if ( isset($gallery_image_count) && $gallery_image_count > 0 && $wp_rem_image_gallery_switch == 'on' ) { ?>
                                        ...
                                        <div class="text-holder">
                                            <div class="post-title">
                                                <h4><a href="<?php the_permalink(); ?>"><?php echo wp_trim_words(get_the_title($property_id), 3); ?></a></h4>
                                            </div>
                                            <?php
                                            ...
                                            if ( isset($wp_rem_property_price_options) && $wp_rem_property_price_options == 'price' ) {
                                                ...
                                                ?>
                                                <span class="property-price"><?php echo force_balance_tags($wp_rem_property_price).' '.$phone_number; ?><small></small></span>
                                            <?php } ?>
                                            <div class="post-time">
                                                <small>
                                                    <?php
    ...
    <aside class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        ...
        <form class="contactform_name" id="contactfrm<?php echo absint($wp_rem_cs_email_counter); ?>" name="contactform_name" onsubmit="return wp_rem_contact_send_message(<?php echo absint($wp_rem_cs_email_counter); ?>)">
                    ...
                    while ( $custom_query_featured->have_posts() ) : $custom_query_featured->the_post();
                        ...
                        <div class="property-grid">
                            ...
                            <div class="text-holder">
                                ...
                                if ( get_the_title($nearby_property_id) != '' ) {
                                    ?>
                                    <div class="post-title">
