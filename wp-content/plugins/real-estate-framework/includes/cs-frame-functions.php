            ...
            <div id="<?php echo esc_attr($randomno); ?>_del" class="column columnmain parentdeletesection column_100" >
                ...
                <div class="column column_container page_section <?php echo sanitize_html_class($column_class); ?>" >
                    ...
                    if ( isset($column_container) ) {
                        global $wpdb;
                        $shortcodes_array = isset( $shortcodes_array )? $shortcodes_array : array();
                            ...
                            ?>">
                                <div class="form-elements">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <label><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_cs_var_video_url'); ?></label>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        <div class="input-sec1">
                                            <?php
                                            $wp_rem_cs_opt_array = array(
                                                'std' => esc_url($wp_rem_cs_section_video_url),
                                                'cust_id' => '',
                                            ...
                                            <label class="browse-icon">
                                                ...
                                                $wp_rem_cs_opt_array = array(
                                                    ...
                                                    'cust_name' => 'wp_rem_cs_var_section_video_url_' . esc_attr($randomno),
                                                    'extra_atr' => '',
                                                );
                                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_text_render($wp_rem_cs_opt_array);
                                                ?>
...
if ( ! function_exists('wp_rem_cs_var_page_builder_element_sizes') ) {
    ...
    function wp_rem_cs_var_page_builder_element_sizes($size = '100', $atts = '') {
        ...
        if ( isset($atts['wp_rem_res_large_device_width']) && $atts['wp_rem_res_large_device_width'] != '' ) {
            $element_size_arr['lg'] = $atts['wp_rem_res_large_device_width'];
        }
        if ( isset($atts['wp_rem_res_medium_device_width']) && $atts['wp_rem_res_medium_device_width'] != '' ) {
            $element_size_arr['md'] = $atts['wp_rem_res_medium_device_width'];
        }
        if ( isset($atts['wp_rem_res_sm_device_width']) && $atts['wp_rem_res_sm_device_width'] != '' ) {
            $element_size_arr['sm'] = $atts['wp_rem_res_sm_device_width'];
        }
        if ( isset($atts['wp_rem_res_xs_device_width']) && $atts['wp_rem_res_xs_device_width'] != '' ) {
            $element_size_arr['xs'] = $atts['wp_rem_res_xs_device_width'];
        }

        $element_size = $element_size_arr['lg'] . ' ' . $element_size_arr['md'] . ' ' . $element_size_arr['sm'] . ' ' . $element_size_arr['xs'];
        if ( isset($atts['wp_rem_res_large_device_offset']) && $atts['wp_rem_res_large_device_offset'] != '' ) {
            $element_size .= ' ' . $atts['wp_rem_res_large_device_offset'];
        }
        if ( isset($atts['wp_rem_res_medium_device_offset']) && $atts['wp_rem_res_medium_device_offset'] != '' ) {
            $element_size .= ' ' . $atts['wp_rem_res_medium_device_offset'];
        }
        if ( isset($atts['wp_rem_res_sm_device_offset']) && $atts['wp_rem_res_sm_device_offset'] != '' ) {
            $element_size .= ' ' . $atts['wp_rem_res_sm_device_offset'];
        }
        if ( isset($atts['wp_rem_res_xs_device_offset']) && $atts['wp_rem_res_xs_device_offset'] != '' ) {
            $element_size .= ' ' . $atts['wp_rem_res_xs_device_offset'];
        }
        //
        if ( isset($atts['wp_rem_res_large_device_hide']) && $atts['wp_rem_res_large_device_hide'] == 'yes' ) {
            $element_size .= ' hidden-lg';
        }
        if ( isset($atts['wp_rem_res_medium_device_hide']) && $atts['wp_rem_res_medium_device_hide'] == 'yes' ) {
            $element_size .= ' hidden-md';
        }
        if ( isset($atts['wp_rem_res_sm_device_hide']) && $atts['wp_rem_res_sm_device_hide'] == 'yes' ) {
            $element_size .= ' hidden-sm';
        }
        if ( isset($atts['wp_rem_res_xs_device_hide']) && $atts['wp_rem_res_xs_device_hide'] == 'yes' ) {
 ...
 * @return array
 */
if ( ! function_exists('wp_rem_bootstrap_columns_set') ) {

    function wp_rem_bootstrap_columns_set($device = 'lg') {

        $cloumns_set = array(
            "" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_default_txt'),
            "col-{$device}-1" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_1_width'),
            "col-{$device}-2" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_2_width'),
            "col-{$device}-3" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_3_width'),
            "col-{$device}-4" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_4_width'),
            "col-{$device}-5" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_5_width'),
            "col-{$device}-6" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_6_width'),
            "col-{$device}-7" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_7_width'),
            "col-{$device}-8" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_8_width'),
            "col-{$device}-9" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_9_width'),
            "col-{$device}-10" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_10_width'),
            "col-{$device}-11" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_11_width'),
            "col-{$device}-12" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_12_width'),
        );

        return apply_filters('wp_rem_bootstrap_columns_set', $cloumns_set, $device);
    }
 ...
 * @return array
 */
if ( ! function_exists('wp_rem_bootstrap_columns_offset_options') ) {

    function wp_rem_bootstrap_columns_offset_options($device = 'lg') {

        $cloumns_set = array(
            "" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_default_txt'),
            "col-{$device}-offset-0" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_no_offset_txt'),
            "col-{$device}-offset-1" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_1_width'),
            "col-{$device}-offset-2" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_2_width'),
            "col-{$device}-offset-3" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_3_width'),
            "col-{$device}-offset-4" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_4_width'),
            "col-{$device}-offset-5" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_5_width'),
            "col-{$device}-offset-6" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_6_width'),
            "col-{$device}-offset-7" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_7_width'),
            "col-{$device}-offset-8" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_8_width'),
            "col-{$device}-offset-9" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_9_width'),
            "col-{$device}-offset-10" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_10_width'),
            "col-{$device}-offset-11" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_11_width'),
            "col-{$device}-offset-12" => wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_12_width'),
        );

        return apply_filters('wp_rem_bootstrap_columns_offset', $cloumns_set, $device);
    }
 ...
 * @return
 */
if ( ! function_exists('wp_rem_shortcode_default_atts_extend') ) {

    add_filter('wp_rem_shortcode_default_atts', 'wp_rem_shortcode_default_atts_extend', 10, 2);

    function wp_rem_shortcode_default_atts_extend($atts = array(), $atts_set = array()) {

        if ( isset($atts_set['responsive_atts']) && $atts_set['responsive_atts'] === true ) {
            $atts['wp_rem_res_large_device_width'] = '';
            $atts['wp_rem_res_large_device_offset'] = '';
            $atts['wp_rem_res_large_device_hide'] = '';
            //
            $atts['wp_rem_res_medium_device_width'] = '';
            $atts['wp_rem_res_medium_device_offset'] = '';
            $atts['wp_rem_res_medium_device_hide'] = '';
            //
            $atts['wp_rem_res_sm_device_width'] = '';
            $atts['wp_rem_res_sm_device_offset'] = '';
            $atts['wp_rem_res_sm_device_hide'] = '';
            //
            $atts['wp_rem_res_xs_device_width'] = '';
            $atts['wp_rem_res_xs_device_offset'] = '';
            $atts['wp_rem_res_xs_device_hide'] = '';
        }
 ...
 * @return
 */
if ( ! function_exists('wp_rem_shortcode_default_atts_save') ) {

    add_filter('wp_rem_shortcode_default_atts_save', 'wp_rem_shortcode_default_atts_save', 10, 4);

    function wp_rem_shortcode_default_atts_save($atts = '', $post_data = 0, $counter = 0, $atts_set = array()) {

        if ( isset($atts_set['responsive_atts']) && $atts_set['responsive_atts'] === true ) {

            if ( isset($post_data['wp_rem_res_large_device_width'][$counter]) && $post_data['wp_rem_res_large_device_width'][$counter] != '' ) {
                $atts .= ' wp_rem_res_large_device_width="' . $post_data['wp_rem_res_large_device_width'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_large_device_offset'][$counter]) && $post_data['wp_rem_res_large_device_offset'][$counter] != '' ) {
                $atts .= ' wp_rem_res_large_device_offset="' . $post_data['wp_rem_res_large_device_offset'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_large_device_hide'][$counter]) && $post_data['wp_rem_res_large_device_hide'][$counter] != '' ) {
                $atts .= ' wp_rem_res_large_device_hide="' . $post_data['wp_rem_res_large_device_hide'][$counter] . '" ';
            }
            //
            if ( isset($post_data['wp_rem_res_medium_device_width'][$counter]) && $post_data['wp_rem_res_medium_device_width'][$counter] != '' ) {
                $atts .= ' wp_rem_res_medium_device_width="' . $post_data['wp_rem_res_medium_device_width'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_medium_device_offset'][$counter]) && $post_data['wp_rem_res_medium_device_offset'][$counter] != '' ) {
                $atts .= ' wp_rem_res_medium_device_offset="' . $post_data['wp_rem_res_medium_device_offset'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_medium_device_hide'][$counter]) && $post_data['wp_rem_res_medium_device_hide'][$counter] != '' ) {
                $atts .= ' wp_rem_res_medium_device_hide="' . $post_data['wp_rem_res_medium_device_hide'][$counter] . '" ';
            }
            //
            if ( isset($post_data['wp_rem_res_sm_device_width'][$counter]) && $post_data['wp_rem_res_sm_device_width'][$counter] != '' ) {
                $atts .= ' wp_rem_res_sm_device_width="' . $post_data['wp_rem_res_sm_device_width'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_sm_device_offset'][$counter]) && $post_data['wp_rem_res_sm_device_offset'][$counter] != '' ) {
                $atts .= ' wp_rem_res_sm_device_offset="' . $post_data['wp_rem_res_sm_device_offset'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_sm_device_hide'][$counter]) && $post_data['wp_rem_res_sm_device_hide'][$counter] != '' ) {
                $atts .= ' wp_rem_res_sm_device_hide="' . $post_data['wp_rem_res_sm_device_hide'][$counter] . '" ';
            }
            //
            if ( isset($post_data['wp_rem_res_xs_device_width'][$counter]) && $post_data['wp_rem_res_xs_device_width'][$counter] != '' ) {
                $atts .= ' wp_rem_res_xs_device_width="' . $post_data['wp_rem_res_xs_device_width'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_xs_device_offset'][$counter]) && $post_data['wp_rem_res_xs_device_offset'][$counter] != '' ) {
                $atts .= ' wp_rem_res_xs_device_offset="' . $post_data['wp_rem_res_xs_device_offset'][$counter] . '" ';
            }
            if ( isset($post_data['wp_rem_res_xs_device_hide'][$counter]) && $post_data['wp_rem_res_xs_device_hide'][$counter] != '' ) {
                $atts .= ' wp_rem_res_xs_device_hide="' . $post_data['wp_rem_res_xs_device_hide'][$counter] . '" ';
            }
        }
 ...
 * @return
 */
if ( ! function_exists('wp_rem_shortcode_fields_extend') ) {

    add_action('wp_rem_shortcode_fields_render', 'wp_rem_shortcode_fields_extend', 10, 2);

    function wp_rem_shortcode_fields_extend($output = array(), $atts_set = array()) {
        global $wp_rem_cs_var_html_fields, $wp_rem_cs_var_form_fields;
        ...
        if ( isset($atts_set['responsive_fields']) && $atts_set['responsive_fields'] === true ) {
            ...
            <div class="shortcode-responsive-fields">
                <h2><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_settings_heading') ?></h2>
                <table class="responsive-fields-table">
                    <thead>
                    <th><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_device_txt') ?></th>
                    <th><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_column_width') ?></th>
                    <th><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_offset_txt') ?></th>
                    <th><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_hide_txt') ?></th>
                    </thead>
                    <tbody>
                        <tr>
                            <td><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_large_txt') ?></td>
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_large_device_width) ? $wp_rem_res_large_device_width : '',
                                    'cust_id' => 'wp_rem_res_large_device_width',
                                    'cust_name' => 'wp_rem_res_large_device_width[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_set('lg'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            </td>
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_large_device_offset) ? $wp_rem_res_large_device_offset : '',
                                    'cust_id' => 'wp_rem_res_large_device_offset',
                                    'cust_name' => 'wp_rem_res_large_device_offset[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_offset_options('lg'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            ...
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_large_device_hide) ? $wp_rem_res_large_device_hide : '',
                                    'cust_id' => 'wp_rem_res_large_device_hide',
                                    'cust_name' => 'wp_rem_res_large_device_hide[]',
                                    'classes' => 'chosen-select-no-single',
                        ...
                        <tr>
                            <td><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_medium_txt') ?></td>
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_medium_device_width) ? $wp_rem_res_medium_device_width : '',
                                    'cust_id' => 'wp_rem_res_medium_device_width',
                                    'cust_name' => 'wp_rem_res_medium_device_width[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_set('md'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            ...
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_medium_device_offset) ? $wp_rem_res_medium_device_offset : '',
                                    'cust_id' => 'wp_rem_res_medium_device_offset',
                                    'cust_name' => 'wp_rem_res_medium_device_offset[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_offset_options('md'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            ...
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_medium_device_hide) ? $wp_rem_res_medium_device_hide : '',
                                    'cust_id' => 'wp_rem_res_medium_device_hide',
                                    'cust_name' => 'wp_rem_res_medium_device_hide[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => $yes_no_options,
                                    'return' => false,
                                );
                        ...
                        <tr>
                            <td><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_small_medium_txt') ?></td>
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_sm_device_width) ? $wp_rem_res_sm_device_width : '',
                                    'cust_id' => 'wp_rem_res_sm_device_width',
                                    'cust_name' => 'wp_rem_res_sm_device_width[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_set('sm'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            ...
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_sm_device_offset) ? $wp_rem_res_sm_device_offset : '',
                                    'cust_id' => 'wp_rem_res_sm_device_offset',
                                    'cust_name' => 'wp_rem_res_sm_device_offset[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_offset_options('sm'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            ...
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_sm_device_hide) ? $wp_rem_res_sm_device_hide : '',
                                    'cust_id' => 'wp_rem_res_sm_device_hide',
                                    'cust_name' => 'wp_rem_res_sm_device_hide[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => $yes_no_options,
                                    'return' => false,
                                );
                        ...
                        <tr>
                            <td><?php echo wp_rem_cs_var_frame_text_srt('wp_rem_responsive_small_txt') ?></td>
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_xs_device_width) ? $wp_rem_res_xs_device_width : '',
                                    'cust_id' => 'wp_rem_res_xs_device_width',
                                    'cust_name' => 'wp_rem_res_xs_device_width[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_set('xs'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            ...
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_xs_device_offset) ? $wp_rem_res_xs_device_offset : '',
                                    'cust_id' => 'wp_rem_res_xs_device_offset',
                                    'cust_name' => 'wp_rem_res_xs_device_offset[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => wp_rem_bootstrap_columns_offset_options('xs'),
                                    'return' => false,
                                );
                                $wp_rem_cs_var_form_fields->wp_rem_cs_var_form_select_render($wp_rem_cs_opt_array);
                                ?>
                            ...
                            <td>
                                <?php
                                $wp_rem_cs_opt_array = array(
                                    'std' => isset($wp_rem_res_xs_device_hide) ? $wp_rem_res_xs_device_hide : '',
                                    'cust_id' => 'wp_rem_res_xs_device_hide',
                                    'cust_name' => 'wp_rem_res_xs_device_hide[]',
                                    'classes' => 'chosen-select-no-single',
                                    'options' => $yes_no_options,
                                    'return' => false,
                                );
