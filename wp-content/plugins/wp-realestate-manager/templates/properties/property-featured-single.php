                    ...
                    <div class="swiper-slide" itemscope itemtype="<?php echo force_balance_tags($http_request); ?>schema.org/Product">
                        ...
                        <div class="<?php echo esc_html($col_class); ?>">
                            <div class="column-text classic">
                                <h2 itemprop="name"><a href="<?php echo esc_url(get_permalink($property_id)); ?>"><?php echo esc_html(wp_trim_words(get_the_title($property_id), $wp_rem_property_title_limit)) ?></a></h2>
                                <p itemprop="description" class="description"><?php echo wp_trim_words(get_the_content($property_id), $properties_content_limit, ' ...'); ?></p>
                                <?php
