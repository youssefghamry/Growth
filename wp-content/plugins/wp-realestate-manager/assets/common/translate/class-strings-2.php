...
if ( ! class_exists('wp_rem_plugin_all_strings_2') ) {
    ...
    class wp_rem_plugin_all_strings_2 {
        ...
        public function wp_rem_plugin_text_strings_callback($wp_rem_static_text) {
            ...
            $wp_rem_static_text['wp_rem_property_type_meta_maximum_options_filter'] = esc_html__('Number of Price option', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_type_meta_maximum_options_filter_desc'] = esc_html__('This will be the maximum number of price options on the search filters, You can add only maximum 50 intervals.', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_property_type_meta_only_num_allwd'] = esc_html__('It will display in property detail page (request viewing popup)', 'wp-rem');
	    ...
	    $wp_rem_static_text['wp_rem_plugin_options_create_property_pge'] = esc_html__('Property Submission Page ', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_plugin_options_dashboard_pagination'] = esc_html__(' User Dashboard Pagination', 'wp-rem');
	    ...
	    $wp_rem_static_text['wp_rem_plugin_options_property_page_slug'] = esc_html__('Property Page Slug', 'wp-rem');
	    $wp_rem_static_text['wp_rem_plugin_options_property_page_slug_option'] = esc_html__('Property Page Slug Option', 'wp-rem');
	    
            $wp_rem_static_text['wp_rem_plugin_options_dflt_lstng_cs_field'] = esc_html__('Default Properties Custom Fields', 'wp-rem');
            $wp_rem_static_text['wp_rem_plugin_options_property_cs_field'] = esc_html__('Property Settings', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_plugin_options_term_policy_descr_hint'] = esc_html__('Please add text for term & policy with link', 'wp-rem');
			 $wp_rem_static_text['wp_rem_plugin_options_term_condition_page'] = esc_html__('Term and Conditions', 'wp-rem');
			  $wp_rem_static_text['wp_rem_plugin_options_term_condition_page_hint'] = esc_html__('Please select page for term and conditions', 'wp-rem');
			  $wp_rem_static_text['wp_rem_plugin_options_privacy_policy_page'] = esc_html__('Privacy Policy', 'wp-rem');
			  $wp_rem_static_text['wp_rem_plugin_options_privacy_policy_page_hint'] = esc_html__('Please select page for privacy policy', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_plugin_options_social_sharing_google_plus'] = esc_html__('Google', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_plugin_seetings_mobile_hint'] = esc_html__('Enter Phone Number', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_enquiry_detail_created'] = esc_html__('Created', 'wp-rem');
             ...
             * properties php
             */
            $wp_rem_static_text['wp_rem_property_php_tag_name'] = esc_html__('Property Tags', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_property_php_tag_menu_name'] = esc_html__('Property Tags', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_top_properties_widget'] = __('REM : Top Properties', 'wp-rem');
            $wp_rem_static_text['wp_rem_top_properties_widget_desc'] = __('To show Top Properties in widget.', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_property_categories_label'] = esc_html__('Categories', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_property_hidden_heading'] = esc_html__('You have hidden %s property on this page', 'wp-rem');
			$wp_rem_static_text['wp_rem_properties_hidden_heading'] = esc_html__('You have hidden %s properties on this page', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_property_hide'] = esc_html__('Hide Property', 'wp-rem');
			$wp_rem_static_text['wp_rem_property_hidden'] = esc_html__('Hidden Property', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_favourite_remove_one_list'] = esc_html__(' removed your property from favourites.', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_properties_detail_view'] = esc_html__('Photos', 'wp-rem');
            $wp_rem_static_text['wp_rem_properties_detail_location'] = esc_html__('Map View', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_compared_label'] = esc_html__('Compared', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_cannot_add_to_list'] = esc_html__('Sorry! cannot add to compare list', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_already_compared'] = esc_html__('Already compared', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_add_to_compare'] = esc_html__('Compare', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_added_successfully_to'] = esc_html__('Added successfully to', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_added_to_compare'] = esc_html__('Added to compare', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_compare_was_removed_from_compare'] = esc_html__('Successfully removed', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_remove_to_compare'] = esc_html__('Remove Compare', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_shortcode_heading'] = esc_html__('REM: Properties Compare', 'wp-rem');
			$wp_rem_static_text['wp_rem_compare_compare_list_is_empty'] = esc_html__('Please add at least two item in list then try it. %s', 'wp-rem');
			...
			$wp_rem_static_text['wp_rem_plugin_options_select_cookies_page'] = esc_html__('Cookies Page', 'wp-rem');
			$wp_rem_static_text['wp_rem_plugin_options_select_cookies_page_hit'] = esc_html__('Please select page for Cookies.', 'wp-rem');
