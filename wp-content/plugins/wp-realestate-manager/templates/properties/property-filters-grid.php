                        ...
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <div class="caption-inner">
                                    <?php if ( $wp_rem_property_type_price_switch == 'on' && $wp_rem_property_price != '' && $property_view == 'v2' ) { ?>
                        ...
                        if ( $property_view == 'v2' ) {
                            ...
                            if ( ! empty($get_property_location) ) {
                                ...
                                <ul class="property-location">
                                    <li><i class="icon-location-pin2"></i> <?php echo esc_html(implode(' / ', $get_property_location)); ?></li>
                                </ul>
                            <?php } ?>
