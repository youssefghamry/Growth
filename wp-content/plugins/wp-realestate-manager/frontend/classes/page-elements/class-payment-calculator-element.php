...
if ( ! class_exists('wp_rem_payment_calculator_element') ) {
    ...
    class wp_rem_payment_calculator_element {
        ...
        public function wp_rem_payment_calculator_html_callback($property_id = '') {
            ...
            $sidebar_mortgage_calculator = wp_rem_element_hide_show($property_id, 'sidebar_mortgage_calculator');
            ...
            if ( $property_id != '' ) {
                ...
                <div class="widget widget-payment-sec pd0">
                    ...
                    $currency_sign = wp_rem_get_currency_sign('symbol', $property_id);
                    $convert_price = true;
                        ...
                        <script type="text/javascript">
                            function doCalc(button_loader)
                            {
                                ...
                                setTimeout(function () {
                                    ...
                                    var currency_active = jQuery("#currency-format").val(); // change currency format for customization process
                                    if (typeof currency_active != 'undefined' && currency_active == 'active') {
                                        total = currency_format(total);
                                    }

                                    var final_currency_show = currency_pos_set(total, currency_sign);

                                    jQuery(".totoal_price").html(final_currency_show + ' / <small><?php echo wp_rem_plugin_text_srt('wp_rem_mortgage_calculator_month'); ?></small>');
                                    if (total > 0) {
                            ...
                            function currency_pos_set(total, currency_sign) {

                                var currency_position = '<?php echo esc_html($currency_pos); ?>';

                                if (currency_position == 'right') {
                                    var final_currency_show = total + currency_sign;
                                } else if (currency_position == 'left_space') {
                                    var final_currency_show = currency_sign + ' ' + total;
                        ...
                        <form name="mortform" action="#" method="post">
                            <div class="progress-holder">
                                ...
                                <div class="text-holder">
                                    ...
                                    <span class="price totoal_price"><?php echo force_balance_tags(wp_rem_get_currency($wp_rem_property_price, true, '', '', $convert_price, $property_id)); ?> / <small><?php echo wp_rem_plugin_text_srt('wp_rem_payment_calculator_mo'); ?></small></span>
                                    <ul>
                            ...
                            <div class="range-slider-holder">
                                <div class="range-slider">
                                    ...
                                    if ( $currency_pos == 'right' ) {
                                        $currency_right = wp_rem_get_currency_sign('symbol', $property_id);
                                    } else if ( $currency_pos == 'left_space' ) {
                                        $currency_left = wp_rem_get_currency_sign('symbol', $property_id);
                                    ...
                                    ?>
                                    <span id="#ex5SliderVal" class="price"><?php echo $currency_left; ?><small class="slider-value"> <?php echo wp_rem_get_currency($default_property_price, false); ?></small><?php echo $currency_right; ?></span>
                                    <?php
                                    $wp_rem_form_fields_frontend->wp_rem_form_text_render(
                                            array(
                                                ...
                                                'extra_atr' => ' data-slider-id="ex2Slider" data-slider-min="0" data-slider-step="1" data-slider-max="' . ($wp_rem_property_price) . '"  data-slider-value="' . ($wp_rem_property_price) . '" style="display:none;"',
                                            )
                                    );
                                    ?>  
                                </div>
                                <div class="range-slider">
                                    ...
                                    <span id="#ex6SliderVal" class="price"><?php echo $currency_left; ?><small class="slider-value"><?php echo wp_rem_get_currency($default_deposit_pricee, false); ?></small><?php echo $currency_right; ?></span>
                                    <?php
                                    $wp_rem_form_fields_frontend->wp_rem_form_text_render(
                                            array(
                                                ...
                                                'cust_id' => 'ex3',
                                                'classes' => 'slider-field',
                                                'extra_atr' => ' data-slider-id="ex2Slider" data-slider-min="0" data-slider-step="1" style="display:none;" data-slider-max="' . $wp_rem_property_price . '"  data-slider-value="' . esc_html($default_deposit_price) . '"',
                                            )
                                    );
                                    ?>  
                                </div>
                                <?php apply_filters('wp_rem_payment_calculator_range_slider_html', $default_annual_int); ?>
                                <?php apply_filters('wp_rem_payment_calculator_range_slider_html_field', ''); ?>
                            ...
                            <span class="price totoal_price"><?php echo force_balance_tags(wp_rem_get_currency($wp_rem_property_price, true)); ?>/<small><?php echo wp_rem_plugin_text_srt('wp_rem_payment_calculator_mo'); ?></small></span>
                        </form>
                        <?php
...
if ( ! function_exists('wp_rem_payment_calculator_range_slider_html_callback') ) {

    function wp_rem_payment_calculator_range_slider_html_callback($default_annual_int = '') {
    ...
    add_filter('wp_rem_payment_calculator_range_slider_html', 'wp_rem_payment_calculator_range_slider_html_callback', 11, 1);
}