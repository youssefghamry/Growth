...
if ( ! class_exists( 'wp_rem_plugin_all_strings_4' ) ) {
	...
	class wp_rem_plugin_all_strings_4 {
		...
		public function __construct() {
			...
			add_filter( 'wp_rem_plugin_text_strings', array( $this, 'wp_rem_plugin_text_strings_callback' ), 3 );
		}
		...
		public function wp_rem_plugin_text_strings_callback( $wp_rem_static_text ) {
			...
			$wp_rem_static_text['wp_rem_list_meta_features_element'] = esc_html__( 'Features', 'wp-rem' );
			$wp_rem_static_text['wp_rem_list_meta_video_element'] = esc_html__( 'Video', 'wp-rem' );
			$wp_rem_static_text['wp_rem_list_meta_yelp_element'] = esc_html__( 'Yelp Places', 'wp-rem' );
			$wp_rem_static_text['wp_rem_list_meta_appartment_element'] = esc_html__( 'Appartment For Sale', 'wp-rem' );
			$wp_rem_static_text['wp_rem_list_meta_file_element'] = esc_html__( 'File Attachments', 'wp-rem' );
			$wp_rem_static_text['wp_rem_list_meta_floor_plan_element'] = esc_html__( 'Floor Plan', 'wp-rem' );
			...
			$wp_rem_static_text['wp_rem_register_allow_search'] = esc_html__( 'Allow In Search', 'wp-rem' );
			...
			$wp_rem_static_text['wp_rem_username_alraedy_exists'] = esc_html__( 'Username alraedy exists.', 'wp-rem' );
			...
			$wp_rem_static_text['wp_rem_enquiry_own_property_error'] = esc_html__( "You can't send enquiry on your own property.", 'wp-rem' );
			...
			$wp_rem_static_text['wp_rem_enquire_arrange_viewing_times_descriptione'] = esc_html__( 'Physical Arrange viewings is always been attractive to property clients. Just fill out the form to arrange visualizations around our properties.', 'wp-rem' );
...
// Start Frontend Nearby Properties Elements.
			...
			$wp_rem_static_text['wp_rem_nearby_properties_price_on_request'] = esc_html__( 'Price On Call', 'wp-rem' );
...
// Start Frontend Payment Calculator Elements.
			...
			$wp_rem_static_text['wp_rem_payment_calculator_get_loan_btn'] = esc_html__( 'Get Loan Quote', 'wp-rem' );
...
// Start Login Form.
			...
			$wp_rem_static_text['wp_rem_element_view_fancy_v4'] = esc_html__( 'Fancy v4', 'wp-rem' );
...
// Start Shortcode Members.
			...
			$wp_rem_static_text['wp_rem_map_search_keyword'] = esc_html__( 'Search Keyword Field', 'wp-rem' );
                        $wp_rem_static_text['wp_rem_pro_search_keyword_criteria'] = esc_html__( 'Search Criteria Sidebar', 'wp-rem' );
                        $wp_rem_static_text['wp_rem_pro_search_keyword_criteria_hint'] = esc_html__( 'Choose yes/no option for view the search criteria results.', 'wp-rem' );
			...
			$wp_rem_static_text['wp_rem_shortcode_properties_left_filters_sidebar'] = esc_html__( 'Filter Sidebar', 'wp-rem' );
			...
			$wp_rem_static_text['wp_rem_shortcode_properties_enquiry_option'] = esc_html__( 'Send Enquiry Property Option', 'wp-rem' );
			$wp_rem_static_text['wp_rem_shortcode_properties_enquiry_option_desc'] = esc_html__( 'You will turn off/on send enquiry option in property element', 'wp-rem' );
			...
			$wp_rem_static_text['wp_rem_shortcode_properties_notes_option'] = esc_html__( 'Property Notes Option', 'wp-rem' );
			$wp_rem_static_text['wp_rem_shortcode_properties_notes_option_desc'] = esc_html__( 'You will turn off/on notes option in property element', 'wp-rem' );
			$wp_rem_static_text['wp_rem_prop_notes_already_added'] = esc_html__( 'You have already added notes for this property.', 'wp-rem' );
