...
if ( ! class_exists('Wp_rem_Currencies') ) {
    ...
    class Wp_rem_Currencies {
        ...
        public function __construct() {
            ...
            add_filter('homevillas_price_filter', array( $this, 'wp_rem_peterjanai_currency_format_change_callback' ), 11, 1);
        }

        public function wp_rem_peterjanai_currency_format_change_callback($price = '') {

            global $wp_rem_plugin_options;
            $wp_rem_thousand_seperator_switch = isset($wp_rem_plugin_options['wp_rem_thousand_seperator_switch']) && ! empty($wp_rem_plugin_options['wp_rem_thousand_seperator_switch']) ? $wp_rem_plugin_options['wp_rem_thousand_seperator_switch'] : '';
            if ( $wp_rem_thousand_seperator_switch == 'on' ) {
        ...
        public function wp_rem_currency_settings_callback($wp_rem_setting_options = array()) {
            ...
            $wp_rem_setting_options[] = array( "name" => esc_html__('Currency Format', 'wp-rem'),
                "id" => "tab-currencies-settings",
                "std" => 'Currency Format',
                "type" => "section",
                "options" => ""
            );
            $wp_rem_setting_options[] = array( "name" => esc_html__('Thousand Separator Switch', 'wp-rem'),
                "desc" => "",
                "label_desc" => '',
                "id" => "thousand_seperator_switch",
                "std" => "off",
                "type" => "checkbox",
                "options" => $on_off_option
            );
