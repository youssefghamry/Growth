...
if (!function_exists('wp_rem_cs_var_page_builder_wp_rem_properties_with_filters')) {
    ...
    function wp_rem_cs_var_page_builder_wp_rem_properties_with_filters($die = 0) {
        ...
        if (function_exists('wp_rem_cs_shortcode_names')) {
            ...
            $defaults = array(
                'filters_properties_title' => '',
                'filters_properties_title_limit' => '',
                'properties_subtitle' => '',
                'properties_filters_alagnment' => '',
                'property_view' => 'v1',
                'filters_property_types' => array(),
                'filters_property_type' => array(),
                'property_sort_by' => 'no',
                ...
                'wp_rem_filter_properties_element_title_color' => '',
                'wp_rem_filter_properties_element_subtitle_color' => '',
                'wp_rem_filter_properties_seperator_style' => '',
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($filters_properties_title),
                                    'id' => 'filters_properties_title',
                                    'cust_name' => 'filters_properties_title[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_filter_properties_element_title_color,
                                    'cust_name' => 'wp_rem_filter_properties_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_filter_properties_element_subtitle_color,
                                    'cust_name' => 'wp_rem_filter_properties_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_filter_properties_seperator_style),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'wp_rem_filter_properties_seperator_style[]',
                                    'return' => true,
                                    'options' => array(
                            ...
                            $wp_rem_post_filters_property_types = new Wp_rem_Post_Property_Types();
                            $filters_property_types_array = $wp_rem_post_filters_property_types->wp_rem_types_array_callback('NULL');
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'multi' => true,
                                'field_params' => array(
                                    'std' => esc_attr($filters_property_type),
                                    'multi' => true,
                                    'id' => 'filters_property_type[]',
                                    'classes' => 'chosen-select',
                                    'cust_name' => 'filters_property_type[]',
                                    'return' => true,
                                    'options' => $filters_property_types_array,
                                ),
                            );
                            //$wp_rem_html_fields->wp_rem_select_field( $wp_rem_opt_array );
                            ?>
                            <script>
                                jQuery(document).ready(function () {
                                    jQuery(".save_filters_property_types_<?php echo absint($property_rand_id); ?>").click(function () {
                                        var MY_SELECT = jQuery('#wp_rem_filters_property_types_<?php echo absint($property_rand_id); ?>').get(0);
                                        var selection = ChosenOrder.getSelectionOrder(MY_SELECT);
                                        var filters_property_type_value = '';
                                        var comma = '';
                                        jQuery(selection).each(function (i) {
                                            filters_property_type_value = filters_property_type_value + comma + selection[i];
                                            comma = ',';
                                        });
                                        console.log(filters_property_type_value);
                                        jQuery('#filters_property_type_<?php echo absint($property_rand_id); ?>').val(filters_property_type_value);
                                    });

                                });
                            </script>
                            <?php
                            $saved_filters_property_type = $filters_property_type;
                            $filters_property_type_options = $filters_property_types_array;

                            if ($filters_property_type != '') {
                                $filters_property_types = is_array($filters_property_type)? $filters_property_type : explode(',', $filters_property_type);
                                foreach ($filters_property_types as $filters_property_type) {
                                    $get_filters_property_types[$filters_property_type] = $filters_property_type_options[$filters_property_type];
                                }
                            }
                            if ($get_filters_property_types) {
                                $filters_property_type_options = array_unique(array_merge($get_filters_property_types, $filters_property_type_options));
                            } else {
                                $filters_property_type_options = $filters_property_type_options;
                            }
                            $wp_rem_opt_array = array(
                                'name' => wp_rem_plugin_text_srt('wp_rem_property_types'),
                                'desc' => '',
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $saved_filters_property_type,
                                    'id' => 'filters_property_types_' . $property_rand_id . '',
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'filters_property_types[]',
                                    'return' => true,
                                    'options' => $filters_property_type_options,
									'extra_atr' => 'data-placeholder="'. wp_rem_plugin_text_srt('wp_rem_select_proprty_type') .'"',
                                ),
                            );
                            $wp_rem_html_fields->wp_rem_select_field($wp_rem_opt_array);
                            ...
                            $wp_rem_cs_opt_array = array(
                                'std' => $saved_filters_property_type,
                                'cust_id' => 'filters_property_type_' . $property_rand_id . '',
                                'cust_name' => "filters_property_type[]",
                                'required' => false
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'field_params' => array(
                                    'std' => esc_attr($filters_properties_title_limit),
                                    'id' => 'filters_properties_title_limit',
                                    'cust_name' => 'filters_properties_title_limit[]',
                                    'return' => true,
                                ),
                            );
                            $wp_rem_html_fields->wp_rem_text_field($wp_rem_opt_array);
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'field_params' => array(
									...
									'extra_atr' => 'data-placeholder="'. wp_rem_plugin_text_srt('wp_rem_select_location_option') .'"',
                                ),
                            );
                            $wp_rem_html_fields->wp_rem_select_field($wp_rem_opt_array);
                            ...
                            $wp_rem_filters_property_type   = isset( $wp_rem_filters_property_type )? $wp_rem_filters_property_type : '';

                            do_action('wp_wp_rem_properties_with_filters_shortcode_admin_fields', array('wp_rem_filters_property_type' => $wp_rem_filters_property_type, 'property_alert_button' => $property_alert_button));
                        ...
                        <?php } else { ?>
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'field_params' => array(
                                    ...
                                    'classes' => 'cs-wp_rem_cs-admin-btn save_filters_property_types_' . $property_rand_id . ' save_property_locations_' . $property_rand_id . '',
    ...
    function wp_rem_cs_save_page_builder_data_wp_rem_properties_with_filters_callback($args) {
        ...
        if ($widget_type == "wp_rem_properties_with_filters" || $widget_type == "cs_wp_rem_properties_with_filters") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['filters_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['filters_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'filters_properties_title="' . htmlspecialchars($data['filters_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_filter_properties_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['wp_rem_filter_properties_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'wp_rem_filter_properties_element_title_color="' . htmlspecialchars($data['wp_rem_filter_properties_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_filter_properties_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['wp_rem_filter_properties_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'wp_rem_filter_properties_seperator_style="' . htmlspecialchars($data['wp_rem_filter_properties_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_filter_properties_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['wp_rem_filter_properties_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'wp_rem_filter_properties_element_subtitle_color="' . htmlspecialchars($data['wp_rem_filter_properties_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['filters_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['filters_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'filters_properties_title_limit="' . htmlspecialchars($data['filters_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['filters_property_type'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['filters_property_type'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'filters_property_type="' . htmlspecialchars($data['filters_property_type'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'property_enquiry_switch="' . htmlspecialchars($data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                
                if (isset($data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']]) && $data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_with_filters .= 'property_notes_switch="' . htmlspecialchars($data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_filters']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_bareber_wp_rem_properties_with_filters, $data, $counters['wp_rem_cs_counter_wp_rem_properties_with_filters'], array( 'responsive_atts' => true ));
                
                $wp_rem_cs_bareber_wp_rem_properties_with_filters = $section_title;
