...
if ( ! class_exists('wp_rem_cs_var_frame_all_strings') ) {
    ...
    class wp_rem_cs_var_frame_all_strings {
        ...
        public function wp_rem_cs_var_frame_all_string_all() {
            ...
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_blog_search'] = __('Blog Search', 'wp-rem-frame');
            ...
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_header_wide_box'] = __('Header Full Width', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_header_wide_box_hint'] = __('Turn this switch on/off for header wide/box', 'wp-rem-frame');
            ...
            //Social media widget
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_media'] = esc_html__('CS : Social media', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_media_desc'] = esc_html__('Enter Social media here.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_info_facebook_url'] = esc_html__('Facebook Page Url', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_info_facebook_url_desc'] = esc_html__('Enter facebook page url here.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_info_twitter_url'] = esc_html__('Twitter user', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_info_twitter_url_desc'] = esc_html__('Enter twitter user here.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_info_google_url'] = esc_html__('Google username/id', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_info_google_url_desc'] = esc_html__('Enter google user or ID  here.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_media_twitter_followers'] = esc_html__('Twitter followers', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_media_google_followers'] = esc_html__('G+ Followers', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_social_media_facebook_followers'] = esc_html__('Facebook Fans', 'wp-rem-frame');
            ...
            // frontend
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_default_success_msg'] = esc_html__('Email has been sent Successfully', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_default_error_msg'] = esc_html__('An error Occured, please try again later', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_first_name'] = esc_html__('Name', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_first_name_placeholder'] = esc_html__('First Name & Last Name', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_last_name'] = esc_html__('Subject', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_last_name_placeholder'] = esc_html__('About this Listing', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_email'] = esc_html__('Email', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_email_address'] = esc_html__('Example@domain.com', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_phone_number'] = esc_html__('Phone Number', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_phone_number_placeholder'] = esc_html__('773.702.8650', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_button_text'] = esc_html__('Send A message', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_message'] = esc_html__('Message', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_check_field'] = esc_html__('Subscribe and Get latest updates and offers by Email', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_received'] = esc_html__('Contact Form Received', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_valid_email'] = esc_html__('Please enter a valid email.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_email_should_not_be_empty'] = esc_html__('Email should not be empty.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_full_name'] = esc_html__('Name', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_contact_ip_address'] = esc_html__('IP Address:', 'wp-rem-frame');

            // backend
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_edit_form'] = esc_html__('Contact Form Options', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_title'] = esc_html__('Element Title', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_title_hint'] = esc_html__('Enter element title here.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_subtitle'] = esc_html__('Element Sub Title', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_subtitle_hint'] = esc_html__('Enter element sub title here', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_var_title_alignment'] = esc_html__('Title Alignment', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_var_title_alignment_hint'] = esc_html__('Select title alignment here', 'wp-rem-frame');
            
            $wp_rem_cs_var_frame_static_text['wp_rem_var_title_color'] = esc_html__('Element Title Color', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_var_title_color_hint'] = esc_html__('Set the element title color here', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_var_subtitle_color'] = esc_html__('Element Subtitle Color', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_var_subtitle_color_hint'] = esc_html__('Set element subtitle color here', 'wp-rem-frame');
            
            $wp_rem_cs_var_frame_static_text['wp_rem_var_align_left'] = esc_html__('Left', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_var_align_right'] = esc_html__('Right', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_var_align_center'] = esc_html__('Center', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_send_to'] = esc_html__('Receiver Email', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_send_to_hint'] = esc_html__('Receiver, or receivers of the mail.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_success_message'] = esc_html__('Success Message', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_success_message_hint'] = esc_html__('Enter Mail Successfully Send Message.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_error_message'] = esc_html__('Error Message', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_error_message_hint'] = esc_html__('Enter Error Message In any case Mail Not Submited.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_save'] = esc_html__('Save', 'wp-rem-frame');

            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_newsletter_email_id'] = esc_html__('Enter Your Email ID', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_newsletter_email_id_name'] = esc_html__('Enter Name', 'wp-rem-frame');
            
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_newsletter_subscribe'] = esc_html__('Subscribe', 'wp-rem-frame');
			...
			$wp_rem_cs_var_frame_static_text['wp_rem_fonts_export_btn_label'] = esc_html__('Export Fonts', 'wp-rem-frame');
            /*
             * Custom Font
             */
            ...
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_title_seperator'] = esc_html__('Seperator', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_title_seperator_hint'] = esc_html__('Set the element title seperator here.', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_title_seperator_none'] = esc_html__('None', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_title_seperator_classic'] = esc_html__('Classic Seperator', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_cs_var_element_title_seperator_zigzag'] = esc_html__('Zigzag Seperator', 'wp-rem-frame');
            
            // Shortcode responsive fields strings
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_settings_heading'] = esc_html__('Responsive Settings', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_device_txt'] = esc_html__('Device', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_width'] = esc_html__('Column Width', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_offset_txt'] = esc_html__('Offset', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_hide_txt'] = esc_html__('Hide', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_large_txt'] = esc_html__('Large', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_medium_txt'] = esc_html__('Medium', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_small_medium_txt'] = esc_html__('Small Medium', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_small_txt'] = esc_html__('Small', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_default_txt'] = esc_html__('Default', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_no_offset_txt'] = esc_html__('No offset', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_1_width'] = esc_html__('1 column - 1/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_2_width'] = esc_html__('2 columns - 2/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_3_width'] = esc_html__('3 columns - 3/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_4_width'] = esc_html__('4 columns - 4/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_5_width'] = esc_html__('5 columns - 5/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_6_width'] = esc_html__('6 columns - 6/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_7_width'] = esc_html__('7 columns - 7/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_8_width'] = esc_html__('8 columns - 8/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_9_width'] = esc_html__('9 columns - 9/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_10_width'] = esc_html__('10 columns - 10/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_11_width'] = esc_html__('11 columns - 11/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_responsive_column_12_width'] = esc_html__('12 columns - 12/12', 'wp-rem-frame');
            $wp_rem_cs_var_frame_static_text['wp_rem_plugin_error'] = esc_html__('Please install the "Homevillas Real Estate" before activating "Real Estate Framework" plugin.', 'wp-rem-frame');
