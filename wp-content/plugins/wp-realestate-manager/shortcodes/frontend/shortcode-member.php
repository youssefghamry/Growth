    ...
    class Wp_rem_Shortcode_Members_Frontend {
        ...
        public function wp_rem_members_content($member_arg = '') {
            ...
            if ( isset($_REQUEST['member_arg']) && $_REQUEST['member_arg'] ) {
                ...
                $member_arg   = stripslashes($member_arg);
                $member_arg = str_replace('\"','"',$member_arg);
                
                $member_arg   = html_entity_decode($member_arg);
                $member_arg = json_decode($member_arg);
            ...
            <form id="frm_member_arg<?php echo esc_html($member_short_counter); ?>">
                ...
                <div class="wp-rem-member-content wp-rem-dev-member-content" id="wp-rem-data-member-content-<?php echo esc_html($member_short_counter); ?>" data-id="<?php echo esc_html($member_short_counter); ?>">
                    ...
                    $wp_rem_memebers_element_title_color = isset($atts['wp_rem_memebers_element_title_color']) ? $atts['wp_rem_memebers_element_title_color'] : '';
                    $wp_rem_memebers_element_subtitle_color = isset($atts['wp_rem_memebers_element_subtitle_color']) ? $atts['wp_rem_memebers_element_subtitle_color'] : '';
                    $wp_rem_member_seperator_style = isset($atts['wp_rem_member_seperator_style']) ? $atts['wp_rem_member_seperator_style'] : '';

                    $element_title_color = '';
                    if ( isset($wp_rem_memebers_element_title_color) && $wp_rem_memebers_element_title_color != '' ) {
                        $element_title_color = ' style="color:' . $wp_rem_memebers_element_title_color . ' ! important"';
                    }
                    $element_subtitle_color = '';
                    if ( isset($wp_rem_memebers_element_subtitle_color) && $wp_rem_memebers_element_subtitle_color != '' ) {
                        $element_subtitle_color = ' style="color:' . $wp_rem_memebers_element_subtitle_color . ' ! important"';
                    }

                    if ( $member_view == 'grid-slider' ) {
                        ?>
                        <div class="element-title <?php echo $members_title_align ?>">
                            <h2<?php echo wp_rem_allow_special_char($element_title_color); ?>><?php echo esc_html($members_title); ?></h2>
                            <?php
                            if ( isset($wp_rem_member_seperator_style) && ! empty($wp_rem_member_seperator_style) ) {
                                $wp_rem_member_seperator_html = '';
                                if ( $wp_rem_member_seperator_style == 'classic' ) {
                                    $wp_rem_member_seperator_html .='<div class="classic-separator ' . $members_title_align . '"><span></span></div>';
                                }
                                if ( $wp_rem_member_seperator_style == 'zigzag' ) {
                                    $wp_rem_member_seperator_html .='<div class="separator-zigzag ' . $members_title_align . '">
                                            <figure><img src="' . trailingslashit(wp_rem::plugin_url()) . 'assets/images/zigzag-img1.png" alt=""/></figure>
                                        </div>';
                                }
                                echo force_balance_tags($wp_rem_member_seperator_html);
                            }
                            ?>
                        ...
                        $wp_rem_element_structure = wp_rem_plugin_title_sub_align($members_title, $members_subtitle, $members_title_align, $wp_rem_memebers_element_title_color, $wp_rem_member_seperator_style, $wp_rem_memebers_element_subtitle_color);
                    }
        ...
        public function member_location_filter($location_slug, $all_post_ids) {
            ...
            if ( $search_type == 'custom' && $radius == 0 ) {
        ...
        public function member_geolocation_filter($location_slug, $all_post_ids, $radius) {
            ...
            if( $distance_symbol == 'km' && is_numeric($radius)){
        ...
        public function wp_rem_member_filter_categories($member_type, $category_request_val) {
            $wp_rem_member_type_category_array = array();
