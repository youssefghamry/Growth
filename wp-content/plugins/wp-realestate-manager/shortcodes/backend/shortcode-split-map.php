    ...
    function wp_rem_cs_var_page_builder_wp_rem_split_map($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                ...
                'wp_rem_map_position' => '',
                'wp_rem_map_fixed' => '',
                'wp_rem_split_map_element_subtitle_color' => '',
                'wp_rem_split_map_element_title_color' => '',
                'wp_rem_split_map_seperator_style' => '',
            );
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_split_map_element_title_color,
                                    'cust_name' => 'wp_rem_split_map_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_split_map_element_subtitle_color,
                                    'cust_name' => 'wp_rem_split_map_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_split_map_seperator_style),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'wp_rem_split_map_seperator_style[]',
                                    'return' => true,
                                    'options' => array(
    ...
    function wp_rem_cs_save_page_builder_data_wp_rem_split_map_callback($args) {
        ...
        if ( $widget_type == "wp_rem_split_map" || $widget_type == "cs_wp_rem_split_map" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_split_map_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_split_map']]) && $data['wp_rem_split_map_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_split_map']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_split_map .= 'wp_rem_split_map_seperator_style="' . htmlspecialchars($data['wp_rem_split_map_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_split_map']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_split_map_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_split_map']]) && $data['wp_rem_split_map_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_split_map']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_split_map .= 'wp_rem_split_map_element_subtitle_color="' . htmlspecialchars($data['wp_rem_split_map_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_split_map']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_split_map_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_split_map']]) && $data['wp_rem_split_map_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_split_map']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_split_map .= 'wp_rem_split_map_element_title_color="' . htmlspecialchars($data['wp_rem_split_map_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_split_map']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['filter_search_box'][$counters['wp_rem_cs_counter_wp_rem_split_map']]) && $data['filter_search_box'][$counters['wp_rem_cs_counter_wp_rem_split_map']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_split_map .= 'filter_search_box="' . htmlspecialchars($data['filter_search_box'][$counters['wp_rem_cs_counter_wp_rem_split_map']], ENT_QUOTES) . '" ';
                }

                // Apply filter on default attributes Saving
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_bareber_wp_rem_split_map, $data, $counters['wp_rem_cs_counter_wp_rem_split_map'], array( 'responsive_atts' => true ));

                $wp_rem_cs_bareber_wp_rem_split_map = $section_title;
                $wp_rem_cs_bareber_wp_rem_split_map .= ']';
