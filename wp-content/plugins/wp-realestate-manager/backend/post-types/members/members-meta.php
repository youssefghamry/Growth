...
if (!class_exists('Wp_rem_Members_Meta')) {
    ...
    class Wp_rem_Members_Meta {
            ...
            <div id="wp-rem-dev-user-property" class="user-list" data-ajax-url="<?php echo esc_url(admin_url('admin-ajax.php')); ?>">  
                ...
                <ul class="panel-group">
                    ...
                    if (isset($all_properties) && !empty($all_properties)) {
                        ?>
                        <li> 
                            <span><?php echo wp_rem_plugin_text_srt('wp_rem_member_properties'); ?></span>
        ...
        function wp_rem_members_options() {
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_user_meta_facebook'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_user_meta_google_plus'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_user_meta_twitter'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
            ...
            $wp_rem_html_fields->wp_rem_text_field($wp_rem_opt_array);
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_user_meta_linkedIn'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
