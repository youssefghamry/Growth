            ...
            if ( $element_property_top_category == 'yes' ) {
                while ( $property_top_categries_loop_obj->have_posts() ) : $property_top_categries_loop_obj->the_post();
                    ...
                    if ( isset($wp_rem_property_type) && ! empty($wp_rem_property_type) ) {
                        ...
                        $post_type_id = wp_rem_wpml_lang_page_id($post_type_id, 'property-type');
                    ...
                    <div class="<?php echo esc_html($columns_class); ?>">
                        <div class="<?php echo esc_html($main_class); ?> <?php echo esc_html($pro_is_compare); ?> list-top-category" itemscope itemtype="<?php echo force_balance_tags($http_request); ?>schema.org/Product">
                    ...
                    <div class="<?php echo esc_html($main_class); ?> <?php echo esc_html($pro_is_compare); ?>" itemscope itemtype="<?php echo force_balance_tags($http_request); ?>schema.org/Product">
                        <div class="img-holder" style="background-image:url('<?php echo esc_url($property_img_url); ?>');" >
                            <figure>
                                ...
                                <figcaption>
                                    ...
                                    echo fetch_property_open_house_grid_view_callback($property_id, 'yes');
                                    ?>
                                    <div class="caption-inner">
                        ...
                        <?php if ( $property_view != 'grid' ) { ?>
                            ...
                            <div class="text-holder">
                                ...
                                if ( isset($property_hide_switch) && $property_hide_switch == 'yes' ) {
                                    ?><a class="hide-btn wp-rem-open-signin-tab" href="javascript:void(0)" onclick="wp_rem_property_hide(this, '<?php echo intval($property_id); ?>', '<?php echo intval($user_id); ?>', '<?php echo intval($property_short_counter); ?>');"><i class="icon-block"></i><?php echo wp_rem_plugin_text_srt('wp_rem_property_hide'); ?></a>
                                    <?php
                                }
                                $ratings_data = array(
                                    'overall_rating' => 0.0,
