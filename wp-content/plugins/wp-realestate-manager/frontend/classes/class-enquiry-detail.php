            ...
            while ( $order_query->have_posts() ): $order_query->the_post();
                ...
                <div class="list-detail-options has-checkbox">
                    ...
                    <div class="element-title"><h4>
                            ...
                            <?php } ?>
                            <?php if ( $type != 'my' ) { ?>
                                <a id="<?php echo esc_html($enquiries_id); ?>" <?php echo $data_param; ?> class="user_dashboard_ajax" href="javascript:void(0);"><?php echo get_the_title($wp_rem_property_id); ?></a>&nbsp;>&nbsp;
                            <?php } ?>
                    ...
                    <div class="order-detail-holder">
                        ...
                        <ul class="order-detail">
                            <li class="created-date">
                                <strong><?php echo wp_rem_plugin_text_srt('wp_rem_enquiry_detail_created'); ?></strong>
