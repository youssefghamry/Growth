    ...
    class Wp_rem_Property_Type_Meta {
        ...
        function wp_rem_post_page_elements_setting() {
            ...
            $wp_rem_opt_array = array(
                ...
                'field_params' => array(
                    'std' => '50',
                    'classes' => 'wp-rem-number-field wp-rem-range-field ',
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_property_type_features_element'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
			...
			$wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_property_type_meta_tags_element'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_print_switch'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_claim_switch'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_flag_switch'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
			...
			do_action('wp_rem_property_type_detail_options', $post->ID);
            ...
            $wp_rem_opt_array = array(
                'name' => wp_rem_plugin_text_srt('wp_rem_property_type_yelp_places'),
                'desc' => '',
                'hint_text' => '',
                'echo' => true,
                'field_params' => array(
			...
			$wp_rem_opt_array = array(
                ...
                'field_params' => array(
                    'std' => 'on',
                    'id' => 'appartments_options_element',
                    'return' => true,
                ),
            );
            ...
            $wp_rem_opt_array = array(
                ...
                'field_params' => array(
                    ...
                    'classes' => 'chosen-select-no-single',
                    'return' => true,
                    'extra_atr' => 'onchange="javascript:wp_rem_property_type_select_view(this.value)"',
                    'options' => array(
            ...
            $wp_rem_property_detail_page_view = isset($wp_rem_plugin_options['wp_rem_property_detail_page_view']) ? $wp_rem_plugin_options['wp_rem_property_detail_page_view'] : 'detail_view1';
            $wp_rem_property_detail_page = get_post_meta($post->ID, 'wp_rem_property_detail_page', true);
            $property_detail_page_selected_view = isset($wp_rem_property_detail_page) && $wp_rem_property_detail_page != '' ? $wp_rem_property_detail_page : $wp_rem_property_detail_page_view;

            if (isset($single_property_options)) {
                $single_property_views = array('detail_view1', 'detail_view2', 'detail_view3', 'detail_view4', 'detail_view5');
                $exclude_options = array();
                $exclude_options['detail_view1'] = array('top_map', 'top_slider', 'top_gallery_map', 'sticky_navigation');
                $exclude_options['detail_view2'] = array('top_map', 'top_slider', 'top_gallery_map', 'sticky_navigation');
                $exclude_options['detail_view3'] = array('top_gallery_map', 'content_gallery');
                $exclude_options['detail_view4'] = array('top_gallery_map', 'content_gallery');
                $exclude_options['detail_view5'] = array('top_map', 'top_slider', 'content_gallery', 'social_networks');
                if (isset($single_property_views)) {
                    foreach ($single_property_views as $single_property_view) {
                        if ($single_property_view == $property_detail_page_selected_view) {
                            $display_fields = 'block';
                        } else {
                            $display_fields = 'none';
                        }
                        echo '<div id="detail_' . $single_property_view . '_fields" style="display: ' . $display_fields . ';">';
                        foreach ($single_property_options as $key => $val) {
                            if (!in_array($key, $exclude_options[$single_property_view])) {
                                $std_val = isset($wp_rem_plugin_options['wp_rem_' . $single_property_view . '_' . $key]) ? $wp_rem_plugin_options['wp_rem_' . $single_property_view . '_' . $key] : 'on';
                                $wp_rem_opt_array = array(
                                    'name' => $val,
                                    'desc' => '',
                                    'hint_text' => '',
        ...
        public function property_type_settings_tab() {
            ...
            $type_icon_group = get_post_meta($post->ID, 'wp_rem_property_type_icon_group', true);
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <?php
                //echo wp_rem_iconlist_plugin_options($type_icon, 'property_type_icon', 'wp_rem_property_type_icon'); 

                echo apply_filters('cs_icons_fields', $type_icon, 'property_type_icon', 'wp_rem_property_type_icon', $type_icon_group);
                ?>
            </div>
            <?php
            echo '</div>';
        ...
        public function property_type_by_category_slug($cate_slug) {
            $property_types_cats = array();
            $args = array(
                'posts_per_page' => "1",
                'post_type' => 'property-type',
            ...
            if ($custom_query->have_posts() <> "") { 
                while ($custom_query->have_posts()): $custom_query->the_post();
                    global $post;
                    $property_type_obj = $post; 
                    return ($property_type_obj->post_name);
                endwhile;
            }
        }
