                        ...
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            <script>
                                jQuery(document).ready(function () {
                                    jQuery(".save_property_categories_<?php echo absint($rand_id); ?>").click(function () {
                                        var MY_SELECT = jQuery('#wp_rem_property_categories_array_<?php echo absint($rand_id); ?>').get(0);
                                        var selection = ChosenOrder.getSelectionOrder(MY_SELECT);
                                        var property_categories_value = '';
                                        var comma = '';

                                        jQuery(selection).each(function (i) {
                                            property_categories_value = property_categories_value + comma + selection[i];
                                            comma = ',';
                                        });
                                        console.log(property_categories_value);
                                        jQuery('#property_categories_<?php echo absint($rand_id); ?>').val(property_categories_value);
                                    });

                                });
                            </script>
                            <?php
                            $property_categories_array = explode(',', $property_categories);
                            $wp_rem_opt_array = array(
                                ...
                                'field_params' => array(
                                    'std' => $property_categories_array,
                                    'id' => 'property_categories_array_' . $rand_id,
                                    'cust_name' => 'property_categories_array[]',
                                    'return' => true,
                                    'classes' => 'chosen-select',
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'cust_id' => 'property_categories_' . $rand_id . '',
            ...
            <?php } else { ?>
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'field_params' => array(
                                    ...
                                    'classes' => 'cs-wp_rem_cs-admin-btn save_property_categories_' . $rand_id,
    ...
    function wp_rem_cs_save_page_builder_data_property_categories_callback($args) {
        ...
        if ( $widget_type == "property_categories" || $widget_type == "cs_property_categories" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                $wp_rem_cs_bareber_property_categories ++;
                $counters['wp_rem_cs_shortcode_counter_property_categories'] ++;
            } else {
                ...
                if ( isset($data['property_categories'][$counters['wp_rem_cs_counter_property_categories']]) && $data['property_categories'][$counters['wp_rem_cs_counter_property_categories']] != '' ) {
                    $wp_rem_cs_bareber_property_categories .= 'property_categories="' . htmlspecialchars($data['property_categories'][$counters['wp_rem_cs_counter_property_categories']], ENT_QUOTES) . '" ';
                }
