...
if ( ! class_exists('wp_rem_plugin_all_strings_1') ) {
    ...
    class wp_rem_plugin_all_strings_1 {
        ...
        public function wp_rem_plugin_strings() {
            ...
            $wp_rem_static_text['wp_rem_create_property_back_to'] = __('Back to %s', 'wp-rem');
            /*
...
// Property Types
            ...
            $wp_rem_static_text['wp_rem_view5'] = esc_html__('View 5', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_location_map'] = esc_html__('Map in content', 'wp-rem');
...
//Property Posted by
            ...
            $wp_rem_static_text['wp_rem_property_posted_google_plus'] = esc_html__('Google', 'wp-rem');
...
// Arrange Viewing Post Type Meta
            ...
            $wp_rem_static_text['wp_rem_arrange_viewings_order_id'] = esc_html__('Viewing ID', 'wp-rem');
...
// Packages meta
            ...
            $wp_rem_static_text['wp_rem_user_meta_google_plus'] = esc_html__('Google', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_property_type_meta_det_page_elements'] = esc_html__('Detail Page Settings', 'wp-rem');
            ...
            $wp_rem_static_text['arrange_viewings_manage'] = esc_html__('Viewings Manage', 'wp-rem');
            $wp_rem_static_text['hidden_properties_manage'] = esc_html__('Hidden Properties Manage', 'wp-rem');
            $wp_rem_static_text['property_notes_manage'] = esc_html__('Property Notes Manage', 'wp-rem');
            $wp_rem_static_text['arrange_viewings_manage'] = esc_html__('Viewings Manage', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_marker_opions_image'] = esc_html__('Image / Icon', 'wp-rem');
            $wp_rem_static_text['wp_rem_marker_opions_map_iamge'] = esc_html__('Map Marker Image', 'wp-rem');
            $wp_rem_static_text['wp_rem_marker_opions_title'] = esc_html__('Title', 'wp-rem');
            $wp_rem_static_text['wp_rem_marker_opions_icon'] = esc_html__('Icon', 'wp-rem');
            $wp_rem_static_text['wp_rem_marker_opions_select_an_icon'] = esc_html__('Select an icon', 'wp-rem');
            $wp_rem_static_text['wp_rem_marker_opions_select_an_imag'] = esc_html__('Select an image', 'wp-rem');
            ...
            $wp_rem_static_text['wp_rem_property_notes'] = esc_html__('Property Notes', 'wp-rem');
            $wp_rem_static_text['wp_rem_property_notes_added'] = esc_html__('Property Notes Added', 'wp-rem');
            $wp_rem_static_text['wp_rem_notes'] = esc_html__('Notes', 'wp-rem');
            $wp_rem_static_text['wp_rem_notes_added'] = esc_html__('Notes Added', 'wp-rem');
            $wp_rem_static_text['wp_rem_notification_removed'] = esc_html__('Activity notification has been removed successfully', 'wp-rem');


            // reviews strings
            // starts here
            $wp_rem_static_text['wp_rem_reviews_name'] = __('Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_singular_name'] = __('Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_add_review'] = __('Add Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_add_new_review'] = __('Add New Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_new_review'] = __('New Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_edit_review'] = __('Edit Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_view_review'] = __('View Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_all_reviews'] = __('All Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_search_reviews'] = __('Search Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_not_found_reviews'] = __('No reviews found.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_not_found_in_trash_reviews'] = __('No reviews found in Trash.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_description'] = __('No reviews found in Trash.', 'wp-rem');

            $wp_rem_static_text['review_title'] = __('Review Title', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_overall_rating'] = __('Overall Rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_username'] = __('User Name', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_detail'] = __('Reviews Detail', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_settings_tab_text'] = __('Reviews/Comments', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_enable_user_reviews'] = __('Review & Ratings', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_enable_user_reviews_hint'] = __('Turn on/off user reviews system.', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_auto_approve_reviews'] = __('Auto Approve Reviews/Comments', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_auto_approve_reviews_hint'] = __('Do you want to Reviews get approved automatically?', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_without_login_user_reviews'] = __('Reviews/Comments Without Login', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_without_login_user_reviews_hint'] = __('Allow user to add review without login.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_enable_review_comment'] = __('Use reviews as Comments', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_enable_multiple_reviews'] = __('Enable Multiple Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_min_length'] = __('Review Min Length', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_max_length'] = __('Review Max Length', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_number_of_reviews'] = __('Number of reviews to list', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_load_more_reviews'] = __('Load More Reviews/Comments Option', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_captcha_for_reviews'] = __('Captcha', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_settings_labels'] = __('Define a set of score values.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_settings_labels_label'] = __('Score Value', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_settings_labels_rating'] = __('Rating Value [1-100]', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_settings_labels_cntrl_delete_row'] = __('Delate Row', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_settings_labels_cntrl_add_row'] = __('+Add Score Value', 'wp-rem');

            $wp_rem_static_text['wp_rem_feature_setting_labels_add'] = __('Add Feature', 'wp-rem');
            $wp_rem_static_text['wp_rem_feature_setting_labels_add_label'] = __('Label', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_total_reviews_label'] = __('Ratings & Reviews', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_total_comments_label'] = __('%d  Comments', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_post_new_reviews_button'] = __('Write new review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_post_new_reviews_comments'] = __('Post new comment', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_rating_summary_heading'] = __('Rating summary', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_overall_rating_heading'] = __('Overall rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_all_reviews_heading'] = __('Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_all_comments_heading'] = __('Comments', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_delete'] = __('Delete', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_delete_this_item'] = __('Delete this item permanently', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_post_name'] = __('Post Name', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_user_txt'] = __('User', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_overall_rating'] = __('Overall Rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_status'] = __('Status', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_date'] = __('Date', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_rating_sumary'] = __('Ratings Summary', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_post_dosnt_exist'] = __('POST DOES NOT EXIST.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_show_more'] = __('Show more...', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_show_less'] = __('Show less', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_ago_txt'] = __('Ago', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_invalid_user'] = __('Invalid user.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_configure_captcha_for_reviews'] = __('This will turn on/off captcha for reviews form. You can configure Captcha API key in plugin API settings.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_score_values'] = __('Score Values', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_name_field'] = __('Name *', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_email_field'] = __('Email *', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_tell_your_experience'] = __('Tell about your experience or leave a tip for others', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_captcha_reload'] = __('Reload', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_min_chars'] = __('Min characters:', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_max_chars'] = __('Max characters:', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_no_perm_to_del_review'] = __('You dont have permissions to delete this review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_slass_coments'] = __('Reviews/Comments', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_total_reviews'] = __('Total Reviews ', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_active_reviews'] = __('Active Reviews ', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_pend_reviews'] = __('Pending Reviews ', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_oall_reviews'] = __('Overall Rating ', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_rate_and_write_a_review_label'] = __('Rate and Write a Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_rate_and_write_a_comment_label'] = __('Write a Comment', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_num_of_reviews_on_your_property'] = __('%s posted a review on your Property <a href="%s">%s</a>.', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_pakage_order_reviews'] = __('Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_pakage_order_response_reviews'] = __('Respond to Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_characters_remaining'] = __('Characters remaining', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_characters_remaining'] = __('Characters remaining', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_marked_helpful'] = __('Helpful', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_marked_flag'] = __('Flag', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_add_new_reviews_close_button'] = __('Close', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_overall_rating_label'] = __('Overall rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_your_overall_rating_label'] = __('Your overall rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_send_your_review_btn'] = __('Submit your Review', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_send_your_comment_btn'] = __('Submit your Comment', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_textarea_word_length'] = __(' Words typed: ', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_read_more_text'] = __('Read More...', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_read_more_reviews_text'] = __('Load More Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_read_more_comments_text'] = __('Load More Comments', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_no_reviews_text'] = __('At the moment i don\'t have any reviews.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_sort_by_highest_rating_option'] = __('Highest Rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_sort_by_lowest_rating_option'] = __('Lowest Rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_sort_by_newest_reviews_option'] = __('Newest Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_request_processing_text'] = __('Processing...', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_incomplete_data_msg'] = __('Incomplete data.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_success_msg'] = __('Your review successfully added.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_no_more_reviews_text'] = __('Sorry, no more reviews.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_already_added_review_msg'] = __('Sorry, You have already added review for this post.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_already_added_review0_msg'] = __('You have already added review.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_already_added_review1_msg'] = __('"You have already added review."', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_already_added_comment1_msg'] = __('"You have already added comment."', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_post_owner_review_msg'] = __('Owner of the post is not allowed to add review.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_withtout_login_msg'] = __('Please login in order to post review.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_recaptcha_error_msg'] = __('Please select captcha field.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_post_notallowed_review_msg'] = __('You are not allowed to post any review.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_post_notallowed_comment_msg'] = __('You are not allowed to post any comment.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_based_on_all_ratings'] = __('based on all ratings', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_would_recomended'] = __('would recommend it to a friend', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_cannot_write_review_on_own_property'] = __('You cannot write review on your own property.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_cannot_write_comment_on_own_property'] = __('You cannot write comment on your own property.', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_dashboard_heading'] = __('My Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_given_reviews_dashboard_heading'] = __('Given Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_dashboard_stats'] = __('%d', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_dashboard_sort_by_label'] = __('Sort by', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_dashboard_sort_by_highest_rating_option'] = __('Highest Rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_dashboard_sort_by_lowest_rating_option'] = __('Lowest Rating', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_dashboard_sort_by_newest_reviews_option'] = __('Newest Reviews', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_dashboard_no_reviews_text'] = __('You haven\'t written any reviews.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_dashboard_delete_success_msg'] = __('Your review successfully got deleted.', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_reply_for'] = __('Reply for', 'wp-rem');
            $wp_rem_static_text['wp_rem_select_review_reply_for'] = __('Select review reply for', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_reply'] = __('Post a reply', 'wp-rem');

            $wp_rem_static_text['wp_rem_select_review_reply_for'] = __('Select review reply for', 'wp-rem');
            $wp_rem_static_text['wp_rem_post_reply'] = __('Post a reply', 'wp-rem');

            $wp_rem_static_text['wp_rem_reviews_review_desc_length_must_be'] = __('Description length must be ', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_review_desc_length_must_be_to'] = __(' to ', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_review_desc_length_must_be_to_long'] = __(' long ', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_error_provide_title'] = __('Review title length must be 3 characters or more', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_error_provide_email_address'] = __('Please provide valid email address.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_error_provide_full_name'] = __('Provided full name must be 3 characters or more', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_property_review_flag_options'] = __('Property Reviews Flag Options', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_text'] = __('Flags', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_single_flag_text'] = __('Flag', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_reason_text'] = __('Reason', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_all_flags'] = __('All Flags', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_edit_flag'] = __('Edit Flag', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_update_flag'] = __('Update Flag', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_add_new_flag'] = __('Add New Flag', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_new_flag_name'] = __('New Flag Name', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_username_text'] = __('Username', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_email_text'] = __('Email', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_no_flag_found'] = __('There is no flag for this review.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_report_submit_successfully'] = __('Your report submit successfully.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_flags_there_is_problem'] = __('There is some problem.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_marked_as_helpful'] = __('Review marked as helpful.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_marked_not_as_helpful'] = __('Review marked as not helpful.', 'wp-rem');
            $wp_rem_static_text['wp_rem_reviews_leave_reply'] = __('Leave Reply', 'wp-rem');
            $wp_rem_static_text['wp_rem_select_review_post_new_reviews'] = __('Post new review', 'wp-rem');
            $wp_rem_static_text['wp_rem_select_review_report_this_review'] = __('Report this review', 'wp-rem');
            $wp_rem_static_text['wp_rem_select_review_choose_report_reason'] = __('Please choose one of the following reasons.', 'wp-rem');
            $wp_rem_static_text['wp_rem_select_review_report_submit'] = __('Submit', 'wp-rem');
            $wp_rem_static_text['wp_rem_select_review_flag_no_reason'] = __('No reason', 'wp-rem');
            /*
