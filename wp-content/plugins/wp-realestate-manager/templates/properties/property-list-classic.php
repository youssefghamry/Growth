...
$properties_excerpt_length = isset($atts['properties_excerpt_length']) ? $atts['properties_excerpt_length'] : '10';
		...
		while ($property_loop_obj->have_posts()) : $property_loop_obj->the_post();
	    	...
	    	<div class="<?php echo esc_html($columns_class); ?>">
				...
				?>
				    ...
				    echo wp_rem_plugin_text_srt('wp_rem_properties_posted') . ' : ';
				...
				echo '<p>' . wp_trim_words(get_the_content($property_id), $properties_excerpt_length) . '</p>';
				?>  
				<?php
