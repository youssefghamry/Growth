...
jQuery(document).ready(function ($) {
    ...
    jQuery(document).on('click', '#team_update_form_backend', function () {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: wp_rem_backend_globals.ajax_url,
...
jQuery(document).on("click", ".add-price-type-opt", function () {
    var thisObj = jQuery(this);
    thisObj.append('<span class="loader-spinner"><i class="icon-spinner8"></i></span>');
    jQuery.ajax({
        type: "POST",
        url: wp_rem_backend_globals.ajax_url,
...
function add_property_category(admin_url) {
    ...
    jQuery(".category-loader").html("<i class='icon-spinner8 icon-spin'></i>");
    jQuery.ajax({
        type: "POST",
        url: admin_url,
        data: dataString,
...
function wp_rem_property_type_change(slug, post_id) {
    ...
    jQuery('#wp-rem-property-type-field').html('<div class="wp-rem-fields-loader"><i class="icon-spinner8 icon-spin"></i></div>');
    jQuery.ajax({
        type: "POST",
        url: wp_rem_ajaxurl,
        data: dataString,
        dataType: 'json',
        success: function (response) {
            if (typeof response.property_fields !== 'undefined') {
                ...
                if (typeof response.detail_options !== 'undefined') {
                    if (response.detail_options.yelp_places == 'on') {
                        jQuery('#wp-rem-property-yelp-holder').show();
                    } else {
                        jQuery('#wp-rem-property-yelp-holder').hide();
                    }
                    if (response.detail_options.floor_plans == 'on') {
                        jQuery('#wp-rem-property-floor-plan-holder').show();
                    } else {
                        jQuery('#wp-rem-property-floor-plan-holder').hide();
                    }
                    if (response.detail_options.appartments == 'on') {
                        jQuery('#wp-rem-property-appartment-holder').show();
                    } else {
                        jQuery('#wp-rem-property-appartment-holder').hide();
                    }
                    ...
                    if (response.detail_options.features == 'on') {
                        ...
                        jQuery('#wp-rem-property-features-btn-holder').show();
                    } else {
                        jQuery('#wp-rem-property-features-holder').hide();
                        jQuery('#wp-rem-property-features-btn-holder').hide();
                    }
                    if (response.detail_options.video == 'on') {
                        jQuery('#wp-rem-property-video-holder').show();
                        jQuery('#wp-rem-property-type-video-con').show();
                    } else {
                        jQuery('#wp-rem-property-video-holder').hide();
                        jQuery('#wp-rem-property-type-video-con').hide();
                    }
                    if (response.detail_options.virtual_tour == 'on') {
                        jQuery('#wp-rem-property-type-virtual-tour-con').show();
                    } else {
                        jQuery('#wp-rem-property-type-virtual-tour-con').hide();
                    }
                    if (response.detail_options.faqs == 'on') {
                        jQuery('#property-types-faqs-side-tab').show();
                    } else {
                        jQuery('#property-types-faqs-side-tab').hide();
                    }
                }
            } else {
...
function wp_rem_show_user_profile_data(user_ID) {
    "use strict";
    var dataString = 'user_profile_id=' + user_ID + '&security=' + wp_rem_backend_globals.security + '&action=wp_rem_posted_by_user_data';
    jQuery('#posted_by_user_data_fields').html('<div class="wp-rem-fields-loader"><i class="icon-spinner8 icon-spin"></i></div>');
    jQuery.ajax({
        type: "POST",
        url: wp_rem_backend_globals.ajax_url,
        data: dataString,
...
jQuery(function ($) {
    ...
    jQuery(document).on("click", ".add_gallery_plugin", "input", function (event) {
...
jQuery(document).on("click", ".floor_plans_repeater_btn", function () {
    "use strict";
...
jQuery(document).on("click", ".attachments_repeater_btn", function () {
    "use strict";
    var repeater_id = jQuery(this).data('id') + '_fields';
...
jQuery(document).on("click", ".near_by_repeater_btn", function () {
    "use strict";
    var repeater_id = jQuery(this).data('id') + '_fields';
    var loading_div = jQuery(this).data('id') + '_loader';
    var dataString = 'action=wp_rem_near_by_repeating_fields&die=true&ajax=true';
    jQuery('#' + loading_div).html('<div class="wp-rem-fields-loader"><i class="icon-spinner8 icon-spin"></i></div>');
    jQuery.ajax({
        type: "POST",
        url: wp_rem_backend_globals.ajax_url,
        data: dataString,
...
jQuery(document).on("click", ".apartment_repeater_btn", function () {
    "use strict";
    var repeater_id = jQuery(this).data('id') + '_fields';
...
jQuery(document).on("click", ".env_res_repeater_btn", function () {
    "use strict";
    var repeater_id = jQuery(this).data('id') + '_fields';
    var loading_div = jQuery(this).data('id') + '_loader';
    ...
    $(function () {
        ...
        $('.backup_generates_area').on('click', '#cs-p-backup-delte', function () {
            "use strict";
                ...
                var var_confirm = window.confirm(wp_rem_backend_globals.delete_selected_file_cofirmation);
            if (var_confirm == true) {
...
function add_package_field(admin_url) {
    ...
    jQuery('.wp-rem-package-button').append(' <span class="loader-spinner"><i class="icon-spinner8"></i></span>');
    jQuery.ajax({
        type: "POST",
        url: admin_url,
        data: dataString,
...
function  wp_rem_banner_add_banner(admin_url) {
    ...
    if (banner_type_input == 'image') {
        if (typeof image_path == 'undefined' || image_path == '') {
            alert(wp_rem_backend_globals.banner_image_error);
            return false;
        }
    }
    ...
    if (banner_type_input == 'code') {
        if (typeof adsense_code_input == 'undefined' || adsense_code_input == '') {
            alert(wp_rem_backend_globals.banner_code_error);
            return false;
        }
    }

    jQuery(".add-banner-button").append(' <span class="loader-spinner"><i class="icon-spinner8"></i></span>');
...
function wp_rem_enquiry_status_change_bk(status_value, enquiry_id) {
    ...
    this_loader.html('<span class="loader-holder"><img src="' + wp_rem_backend_globals.plugin_url + 'assets/backend/images/ajax-loader.gif" alt=""></span>');
...
function wp_rem_load_all_pages(field_id, args) {
    jQuery('.loader-' + field_id).html("<img src='" + wp_rem_backend_globals.plugin_url + "/assets/backend/images/ajax-loader.gif' />").show();
...
function wp_rem_load_all_members(field_class, selected_memebr) {
    jQuery('.' + field_class + ' .members-loader').html("<img src='" + wp_rem_backend_globals.plugin_url + "/assets/backend/images/ajax-loader.gif' />").show();
    jQuery.ajax({
        type: "POST",
        url: wp_rem_backend_globals.ajax_url,
...
function wp_rem_load_dropdown_values(field_class, field_id, action) {
    jQuery('.' + field_class + ' .select-loader').html("<img src='" + wp_rem_backend_globals.plugin_url + "/assets/backend/images/ajax-loader.gif' />").show();
...
$(document).on('click', '.nearby-sel-img-icon-btn', function () {
    var imge_txt = $(this).attr('data-img-txt'),
            ...
            hiden_field = $('#wp_rem_nearby_map_icon_type_' + this_counter);
...
jQuery(document).ready(function ($) {
    jQuery("#profile-page .button-primary").click(function(){
       var user_company = jQuery(".user-company #wp_rem_company" ).val();
       if( user_company == ''){
            jQuery('.user-company .compnay-error').show();
            jQuery(".user-company #wp_rem_company_chosen" ).css("border", "1px solid red");
            jQuery(".user-company #wp_rem_company_chosen" ).css("border-radius", "6px");
            setTimeout(function() {
                jQuery('.user-company .compnay-error').hide();
                jQuery(".user-company #wp_rem_company_chosen" ).css("border", "");
                jQuery(".user-company #wp_rem_company_chosen" ).css("border-radius", "");
            }, 5000);
            return false;
...
function wp_rem_property_type_select_view( val ){
...
function wp_rem_cs_reset_tabs_plugin() {
    "use strict";
    jQuery("#tabbed-content > div").addClass('hidden-tab'); //Hide all content
