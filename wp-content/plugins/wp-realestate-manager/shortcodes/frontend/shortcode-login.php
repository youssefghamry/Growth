        ...
        public function wp_rem_login_shortcode_callback($atts, $content = "") {
            ...
            if (is_user_logged_in()) {
                ...
                if (defined('ICL_LANGUAGE_CODE')) {
                    $output_html .=wp_rem_wpml_lang_code_field();
                }
                if ($wp_rem_demo_user_login_switch == 'on') {
                    ...
                    if (!(isset($wp_rem_demo_member_detail->user_pass) && $wp_hasher->CheckPassword($demo_user_password, $wp_rem_demo_member_detail->user_pass))) {
                        if( isset( $wp_rem_demo_user_member ) && $wp_rem_demo_user_member != '' ){
                    ...
                    if (!(isset($wp_rem_demo_agency_detail->user_pass) && $wp_hasher->CheckPassword($demo_user_password, $wp_rem_demo_agency_detail->user_pass))) {
                        if( isset( $wp_rem_demo_user_agency ) && $wp_rem_demo_user_agency != '' ){
                ...
                $wp_rem_opt_array = array(
                    ...
                    'extra_atr' => ' onkeypress="wp_rem_contact_form_valid_press(this,\'text\')" tabindex="11" placeholder="' . wp_rem_plugin_text_srt('wp_rem_member_username') . '"',
                    'return' => true,
                );
                ...
                $wp_rem_opt_array = array(
                    ...
                    'cust_type' => 'password',
                    'classes' => 'form-control wp-rem-dev-req-field',
                    'extra_atr' => ' placeholder=" ' . wp_rem_plugin_text_srt('wp_rem_register_password') . '" onkeypress="wp_rem_contact_form_valid_press(this,\'text\')" tabindex="12" size="20"',
                    'return' => true,
                );
                $output_html .= $wp_rem_form_fields_frontend->wp_rem_form_text_render($wp_rem_opt_array);
                $output_html .='</div>';
        ...
        public function wp_rem_registration_tab($rand_id = '') {
            ...
            if ($isRegistrationOn) {
                ...
                $wp_rem_opt_array = array(
                    ...
                    'extra_atr' => ' onkeypress="wp_rem_contact_form_valid_press(this,\'text\')" placeholder="' . wp_rem_plugin_text_srt('wp_rem_register_username') . '"',
                ...
                if ($key == NULL) {
                    ...
                    $output_html .=$wp_rem_form_fields_frontend->wp_rem_form_text_render(
                            array('name' => wp_rem_plugin_text_srt('wp_rem_register_company_name'),
                                ...
                                'extra_atr' => ' onkeypress="wp_rem_contact_form_valid_press(this,\'text\')"  placeholder="' . wp_rem_plugin_text_srt('wp_rem_register_company_name') . '"',
                                'std' => '',
                                'return' => true,
                                'classes' => 'company-valid',
                            )
                    );
                    $output_html .= '</div>';
                }
                ...
                if ($key == NULL) {
                    ...
                    $output_html .='<i class="icon-user"></i>';
                    $output_html .=$wp_rem_form_fields_frontend->wp_rem_form_text_render(
                ...
                if (!empty($member_type_array)) {
                    ...
                    $output_html .= '</div>';
                    $allow_options = array(
                        'none' => 'Allow In Search',
                        'no' => 'No',
                        'yes' => 'Yes',
                    );
                    $output_html .='<div class="input-filed">';
                    $output_html .='<i class="icon- icon-search5"></i>';
                    $wp_rem_opt_array = array(
                        'std' => '',
                        'classes' => 'chosen-select-no-single ',
                        'id' => 'allow_search' . $rand_ids,
                        'options' => $allow_options,
                        'return' => true,
                        'description' => '',
                        'name' => '',
                        'extra_atr' => ' data-placeholder="' . wp_rem_plugin_text_srt('wp_rem_register_allow_search') . '"',
                    );
                    $output_html .= $wp_rem_form_fields_frontend->wp_rem_form_select_render($wp_rem_opt_array);
                    $output_html .= '</div>';
                }
                ...
                $output_html .=$wp_rem_form_fields_frontend->wp_rem_form_text_render(
                        array('name' => wp_rem_plugin_text_srt('wp_rem_register_email'),
                            ...
                            'extra_atr' => '  onkeypress="wp_rem_contact_form_valid_press(this,\'email\')" placeholder="' . wp_rem_plugin_text_srt('wp_rem_register_email') . '"' . $readonly . '',
                ...
                $output_html .='<div class="input-filed">';
                $output_html .='<div class="field-holder">';
                $output_html .=' <div class="check-box-remind">';
                $output_html .= wp_rem_term_condition_form_field('register_term_policy', 'term_policy', false);
                $output_html .=' </div>';
                $output_html .=' </div>';
                $output_html .= '</div>';
                ...
                <div class="user-dashboard-menu">
                    <ul>
                        <li class="user-dashboard-menu-children">
                            ...
                            <?php if (($user_roles != '' && in_array("wp_rem_member", $user_roles) ) || in_array('administrator', $user_roles)) {
                                ?>
                                <ul>
                                    ...
                                    if (true === Wp_rem_Member_Permissions::check_permissions('arrange_viewings')) {
                                        ...
                                        ?>
                                        <li class="user_dashboard_ajax" id="wp_rem_member_viewings" data-queryvar="dashboard=viewings"><a href="<?php echo wp_rem_allow_special_char($arrange_viewings_url); ?>"><i class="icon-layers3"></i><?php echo wp_rem_plugin_text_srt('wp_rem_member_register_requested_viewings') ?></a></li>
                                        <?php
                                    }

                                    if (true === Wp_rem_Member_Permissions::check_permissions('reviews')) {
                                        $inquiries_url = '';
                                        $arrange_viewings_url = $this->wp_rem_dashboar_top_menu_url('dashboard=reviews');
                                        if (isset($arrange_viewings_url) && $arrange_viewings_url != '') {
                                            $arrange_viewings_url = $arrange_viewings_url;
                                        } else {
                                            $arrange_viewings_url = 'javascript:void(0)';
                                        ...
                                        ?>
                                        <li class="user_dashboard_ajax" id="wp_rem_publisher_reviews" data-queryvar="dashboard=reviews"><a href="<?php echo wp_rem_allow_special_char($arrange_viewings_url); ?>"><i class="icon-star3"></i><?php echo wp_rem_plugin_text_srt('wp_rem_reviews_all_reviews_heading') ?></a></li>
                                        <?php
                                    }
