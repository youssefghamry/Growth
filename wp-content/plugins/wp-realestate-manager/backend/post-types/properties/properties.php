...
if ( ! class_exists('post_type_property') ) {
    ...
    class post_type_property {
        ...
        public function wp_rem_plugin_db_structure_updater_callback() {
            ...
            $search_keywords_updated = get_option('wp_rem_search_keywords_updated');
            ...
            if ( $search_keywords_updated != 'yes' ) {
                ...
                if ( is_array($property_ids) && ! empty($property_ids) ) {
                    foreach ( $property_ids as $property_id ) {
                        ...
                        $response = $wp_rem_property_meta->wp_rem_save_search_keywords_field( $property_id, $post_obj, 'yes' );
                    }
                }
                update_option('wp_rem_search_keywords_updated', 'yes');
            }
        }
