...
// Update off days.
        ...
        public function member_change_pass_callback() {
            ...
            $member_thumb = isset($_FILES['wp_rem_member_thumb']) ? $_FILES['wp_rem_member_thumb'] : array();
...
// Make sure that this file is included, as wp_generate_attachment_metadata() depends on it.
        ...
        public function wp_rem_member_accounts_save() {
            ...
            $user_info = get_userdata($member_id);
            $company_id = get_user_meta($member_id, 'wp_rem_company', true);
            $display_name = isset( $_POST['member_display_name'] ) ? $_POST['member_display_name'] : '';
            $company_slug = isset( $_POST['member_company_slug'] ) ? $_POST['member_company_slug'] : '';
            $member_email = isset( $_POST['member_email'] ) ? $_POST['member_email'] : '';
            $member_profile_type = isset( $_POST['member_profile_type'] ) ? $_POST['member_profile_type'] : '';
            $member_current_password = isset( $_POST['member_current_password'] ) ? $_POST['member_current_password'] : '';
            $member_new_password = isset( $_POST['member_new_password'] ) ? $_POST['member_new_password'] : '';
            $member_confirm_new_password = isset( $_POST['member_confirm_new_password'] ) ? $_POST['member_confirm_new_password'] : '';
            $member_profile_image = isset( $_POST['member_profile_image'] ) ? $_POST['member_profile_image'] : '';

            $wp_rem_user_phone_number = isset( $_POST['wp_rem_user_phone_number'] ) ? $_POST['wp_rem_user_phone_number'] : '';
            $wp_rem_biography = isset( $_POST['wp_rem_biography'] ) ? $_POST['wp_rem_biography'] : '';
            $wp_rem_user_website = isset( $_POST['wp_rem_user_website'] ) ? $_POST['wp_rem_user_website'] : '';
            $wp_rem_user_facebook = isset( $_POST['wp_rem_user_facebook'] ) ? $_POST['wp_rem_user_facebook'] : '';
            $wp_rem_user_google_plus = isset( $_POST['wp_rem_user_google_plus'] ) ? $_POST['wp_rem_user_google_plus'] : '';
            $wp_rem_user_twitter = isset( $_POST['wp_rem_user_twitter'] ) ? $_POST['wp_rem_user_twitter'] : '';
            $wp_rem_user_linkedIn = isset( $_POST['wp_rem_user_linkedIn'] ) ? $_POST['wp_rem_user_linkedIn'] : '';
            $wp_rem_email_address = $member_email;
            $post = get_post($company_id);
            $company_slug_old = $post->post_name;
            $wp_rem_post_loc_country_member = isset( $_POST['wp_rem_post_loc_country_member'] ) ? $_POST['wp_rem_post_loc_country_member'] : '';
            $wp_rem_post_loc_state_member = isset( $_POST['wp_rem_post_loc_state_member'] ) ? $_POST['wp_rem_post_loc_state_member'] : '';
            $wp_rem_post_loc_city_member = isset( $_POST['wp_rem_post_loc_city_member'] ) ? $_POST['wp_rem_post_loc_city_member'] : '';
            $wp_rem_post_loc_town_member = isset( $_POST['wp_rem_post_loc_town_member'] ) ? $_POST['wp_rem_post_loc_town_member'] : '';
            $wp_rem_post_loc_address = isset( $_POST['wp_rem_post_loc_address_member'] ) ? $_POST['wp_rem_post_loc_address_member'] : '';
            $wp_rem_post_loc_latitude = isset( $_POST['wp_rem_post_loc_latitude_member'] ) ? $_POST['wp_rem_post_loc_latitude_member'] : '';
            $wp_rem_post_loc_longitude = isset( $_POST['wp_rem_post_loc_longitude_member'] ) ? $_POST['wp_rem_post_loc_longitude_member'] : '';
            $wp_rem_post_loc_radius = isset( $_POST['wp_rem_loc_radius_member'] ) ? $_POST['wp_rem_loc_radius_member'] : '';
            $wp_rem_post_loc_zoom = isset( $_POST['wp_rem_post_loc_zoom_member'] ) ? $_POST['wp_rem_post_loc_zoom_member'] : '';
            $wp_rem_post_add_new_loc = isset( $_POST['wp_rem_add_new_loc_member'] ) ? $_POST['wp_rem_add_new_loc_member'] : '';
            ...
            if ( $company_id != '' ) {
                ...
                if ( $wp_rem_user_website != '' ) {
                    update_post_meta($company_id, 'wp_rem_website', $wp_rem_user_website);
                }
                
                if ( $wp_rem_user_facebook != '' ) {
                    update_post_meta($company_id, 'wp_rem_facebook', $wp_rem_user_facebook);
                }
                
                if ( $wp_rem_user_google_plus != '' ) {
                    update_post_meta($company_id, 'wp_rem_google_plus', $wp_rem_user_google_plus);
                }
                
                if ( $wp_rem_user_twitter != '' ) {
                    update_post_meta($company_id, 'wp_rem_twitter', $wp_rem_user_twitter);
                }
                
                if ( $wp_rem_user_linkedIn != '' ) {
                    update_post_meta($company_id, 'wp_rem_linkedIn', $wp_rem_user_linkedIn);
                }
        ...
        public function wp_rem_member_accounts_callback($member_id = '') {
            ...
            if ( ! isset($member_id) || $member_id == '' ) {
                ...
                $wp_rem_user_website = '';
                $wp_rem_user_facebook = '';
                $wp_rem_user_google_plus = '';
                $wp_rem_user_twitter = '';
                $wp_rem_user_linkedIn = '';
                ...
                if ( $company_id != '' ) {
                    ...
                    $wp_rem_user_website = get_post_meta($company_id, 'wp_rem_website', true);
                    $wp_rem_user_facebook = get_post_meta($company_id, 'wp_rem_facebook', true);
                    $wp_rem_user_google_plus = get_post_meta($company_id, 'wp_rem_google_plus', true);
                    $wp_rem_user_twitter = get_post_meta($company_id, 'wp_rem_twitter', true);
                    $wp_rem_user_linkedIn = get_post_meta($company_id, 'wp_rem_linkedIn', true);
                            ...
                            <div class = "row">
                                <form id="member_profile" method="POST">
                                    <div class = "col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                        <div class = "row">
                                            ...
                                            if ( true === Wp_rem_Member_Permissions::check_permissions('company_profile') ) {
                                                ...
                                                <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class = "field-holder">
                                                        <label><?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_facebook'); ?></label>
                                                        <?php
                                                        $wp_rem_opt_array = array(
                                                            'desc' => '',
                                                            'echo' => true,
                                                            'field_params' => array(
                                                                'std' => $wp_rem_user_facebook,
                                                                'id' => 'user_facebook',
                                                                'cust_name' => 'wp_rem_user_facebook',
                                                            ),
                                                        );
                                            ...
                                            <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class = "field-holder">
                                                        <label><?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_google_plus'); ?></label>
                                                        <?php
                                                        $wp_rem_opt_array = array(
                                                            'desc' => '',
                                                            'echo' => true,
                                                            'field_params' => array(
                                                                'std' => $wp_rem_user_google_plus,
                                                                'id' => 'user_google_plus',
                                                                'cust_name' => 'wp_rem_user_google_plus',
                                                            ),
                                                        );
                                            ...
                                            <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class = "field-holder">
                                                        <label><?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_twitter'); ?></label>
                                                        <?php
                                                        $wp_rem_opt_array = array(
                                                            'desc' => '',
                                                            'echo' => true,
                                                            'field_params' => array(
                                                                'std' => $wp_rem_user_twitter,
                                                                'id' => 'user_twitter',
                                                                'cust_name' => 'wp_rem_user_twitter',
                                                            ),
                                                        );
                                            ...
                                            <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class = "field-holder">
                                                        <label><?php echo wp_rem_plugin_text_srt('wp_rem_user_meta_linkedIn'); ?></label>
                                                        <?php
                                                        $wp_rem_opt_array = array(
                                                            'desc' => '',
                                                            'echo' => true,
                                                            'field_params' => array(
                                                                'std' => $wp_rem_user_linkedIn,
                                                                'id' => 'user_linkedIn',
                                                                'cust_name' => 'wp_rem_user_linkedIn',
                                                            ),
                                                        );
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                        <?php
                                        $def_profile_image = isset($wp_rem_plugin_options['wp_rem_default_placeholder_image']) ? $wp_rem_plugin_options['wp_rem_default_placeholder_image'] : array();
                                        ...
                                        <div class="user-profile-images">
                                            ...
                                            <div class="current-img">
                                                <div class="row mt ">
                                                    ...
                                                    <?php
                                                    $hidden_wp_rem_profile_image = isset($wp_rem_profile_image['img']) ? $wp_rem_profile_image['img'] : array();
