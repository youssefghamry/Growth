...
if ( ! class_exists('Wp_rem_Shortcode_Properties_Frontend') ) {
    ...
    class Wp_rem_Shortcode_Properties_Frontend {
        ...
        public function __construct() {
            ...
            add_filter('fetch_property_open_house', array( $this, 'fetch_property_open_house_callback' ), 11, 2);
        }
        ...
        public function wp_rem_properties_shortcode_callback($atts, $content = "") {
            ...
            if ( is_user_logged_in() ) {
                wp_enqueue_script('wp-rem-hide-property-functions');
            }
        ...
        public function wp_rem_properties_content($property_arg = '') {
            ...
            if ( isset($_REQUEST['property_arg']) && $_REQUEST['property_arg'] ) {
                ...
                $property_arg   = stripslashes($property_arg);
                $property_arg = str_replace('\"','"',$property_arg);
                
                $property_arg   = html_entity_decode($property_arg);
                $property_arg = json_decode($property_arg);
            ...
            } elseif ( $property_sort_by == 'low_price' ) {
                $qryvar_property_sort_type = 'ASC';
                $qryvar_sort_by_column = 'meta_value_num';
                $meta_key = 'wp_rem_property_price';
            } elseif ( $property_sort_by == 'high_price' ) {
                $qryvar_property_sort_type = 'DESC';
                $qryvar_sort_by_column = 'meta_value_num';
                $meta_key = 'wp_rem_property_price';
            }
            ...
            if ( $element_property_top_category == 'yes' ) {
                ...
                if ( function_exists('wp_rem_property_visibility_query_args') ) {
                    $element_top_cate_filter_arr = wp_rem_property_visibility_query_args($element_top_cate_filter_arr);
                }
            ...
            $all_post_ids   = apply_filters( 'homevillas_properties_search', $all_post_ids );
            ...
            if ( isset($property_top_categries_loop_obj->posts) && is_array($property_top_categries_loop_obj->posts) && ! empty($property_top_categries_loop_obj->posts) ) {
                ...
                if ( ! empty($all_post_ids) ) {
                    ...
                    /*if ( isset($property_top_categries_loop_obj->posts) && !empty( $property_top_categries_loop_obj->posts ) ) {
                        $all_post_ids = array_intersect($all_post_ids, $property_top_categries_loop_obj->posts);
                    } else {
            ...
            ?>
            <form id="frm_property_arg<?php echo absint($property_short_counter); ?>" class="aaaaaa_2">
                ...
                <?php
                echo '<div class="row">';
                if ( ( $search_box_sidebar == 'yes' && isset($property_view) && $property_view != 'map') || ( !empty($wp_rem_property_sidebar) ) ) {  // if sidebar on from element
                ...
                <div class="<?php echo esc_html($content_columns); ?>">
                    ...
                    <div class="real-estate-property-content real-estate-dev-property-content" id="wp-rem-data-property-content-<?php echo esc_html($property_short_counter); ?>" data-id="<?php echo esc_html($property_short_counter); ?>">
                        ...
                        $property_element_seperator = isset($atts['wp_rem_properties_seperator_style']) ? $atts['wp_rem_properties_seperator_style'] : '';


                        $wp_rem_properties_element_title_color = isset($atts['wp_rem_properties_element_title_color']) ? $atts['wp_rem_properties_element_title_color'] : '';
                        $wp_rem_properties_element_subtitle_color = isset($atts['wp_rem_properties_element_subtitle_color']) ? $atts['wp_rem_properties_element_subtitle_color'] : '';
                        $element_title_color = '';
                        if ( isset($wp_rem_properties_element_title_color) && $wp_rem_properties_element_title_color != '' ) {
                            $element_title_color = ' style="color:' . $wp_rem_properties_element_title_color . ' ! important"';
                        }
                        $element_subtitle_color = '';
                        if ( isset($wp_rem_properties_element_subtitle_color) && $wp_rem_properties_element_subtitle_color != '' ) {
                            $element_subtitle_color = ' style="color:' . $wp_rem_properties_element_subtitle_color . ' ! important"';
                        }
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="element-title <?php echo ($properties_title_alignment); ?>">
                                        ...
                                        if ( $properties_title != '' || $properties_subtitle != '' ) {
                                            if ( $properties_title != '' ) {
                                                ?>
                                                <h2<?php echo wp_rem_allow_special_char($element_title_color); ?>><?php echo esc_html($properties_title); ?></h2>
                                                <?php
                                            }
                                            ...
                                            if ( isset($property_element_seperator) && ! empty($property_element_seperator) ) {
                                                $wp_rem_property_seperator_html = '';
                                                if ( $property_element_seperator == 'classic' ) {
                                                    $wp_rem_property_seperator_html .='<div class="classic-separator ' . $properties_title_alignment . '"><span></span></div>';
                                                }
                                                if ( $property_element_seperator == 'zigzag' ) {
                                                    $wp_rem_property_seperator_html .='<div class="separator-zigzag ' . $properties_title_alignment . '">
                                                                                            <figure><img src="' . trailingslashit(wp_rem::plugin_url()) . 'assets/images/zigzag-img1.png" alt=""/></figure>
                                                                                        </div>';
                                                }
                                                echo force_balance_tags($wp_rem_property_seperator_html);
                                            }
                                        }
                                        ...
                                        <div class="input-field">
                                            ...
                                            $wp_rem_opt_array = array(
                                                ...
                                                'options' => array(
                                                    ...
                                                    'sold' => wp_rem_plugin_text_srt('wp_rem_property_sold_sold_properties'),
                                                    'low_price' => wp_rem_plugin_text_srt('wp_rem_cs_var_filter_lowest_price'),
                                                    'high_price' => wp_rem_plugin_text_srt('wp_rem_cs_var_filter_highest_price')
                                                ),
                                            );
        ...
        public function property_location_filter($location_slug, $all_post_ids) {
            ...
            if ( ($search_type == 'autocomplete' && ($radius == 0 || $radius == '') ) || ($search_type == 'custom' && ($radius == 0 || $radius == '') ) ) {
                ...
                if ( isset($location_slug) && $location_slug != '' ) {
                    $term_exit = term_exists($location_slug, 'wp_rem_locations');
                    if ( $term_exit !== 0 && $term_exit !== null ) {
                        $term = get_term_by('name', $location_slug, 'wp_rem_locations');
...
//				}
        ...
        public function wp_rem_property_filter_categories($property_type, $category_request_val) {
            $wp_rem_property_type_category_array = array();
        ...
        public function wp_rem_property_categories_list($property_type, $parent_cate_string) {
            ...
            if ( $parent_cate_string != '' ) {
                if(!is_array($parent_cate_string) ){
                    $category_request_val_arr = explode(",", $parent_cate_string);
                }
                $count_arr = 0;
                if(isset($category_request_val_arr) && is_array( $category_request_val_arr ) ){
        ...
        public function fetch_property_open_house_callback($property_id, $atts) {
	    ...
	    $property_open_house_filter = isset($atts['property_open_house_filter']) ? $atts['property_open_house_filter'] : '';
            $html = '';
            if ( $open_house_start != '' && $open_house_end != '' && $open_house_check == 'on' && $property_open_house_filter == 'yes' ) {
...
function fetch_property_open_house_grid_view_callback($property_id,  $atts = array()) {
    $open_house_start = get_post_meta($property_id, 'open_house_start', true);
    $open_house_end = get_post_meta($property_id, 'open_house_end', true);
	...
	$show_label = '';
        if ( $show_label == 'yes' ) {
            $html = '<span class="open-house-label">' . wp_rem_plugin_text_srt('wp_rem_properties_open_house') . '</span>';
        } else {
...
function property_search_keywords($property_totnum, $element_property_search_keyword, $qrystr = '', $atts = array(), $page_url = '') {
