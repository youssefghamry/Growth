...
if (!function_exists('wp_rem_cs_var_page_builder_wp_rem_properties_slider')) {
    ...
    function wp_rem_cs_var_page_builder_wp_rem_properties_slider($die = 0) {
        ...
        if (function_exists('wp_rem_cs_shortcode_names')) {
            ...
            $defaults = array(
                'slider_properties_title' => '',
                'properties_subtitle' => '',
                'properties_slider_alignment' => '',
                'slider_properties_title_limit' => '20',
                'property_type' => '',
                ...
                'posts_per_page' => '10',
                'wp_rem_property_slider_element_title_color' => '',
                'wp_rem_property_slider_element_subtitle_color' => '',
                'wp_rem_properties_slider_seperator_style' => '',
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($slider_properties_title),
                                    'id' => 'slider_properties_title',
                                    'cust_name' => 'slider_properties_title[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_property_slider_element_title_color,
                                    'cust_name' => 'wp_rem_property_slider_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_property_slider_element_subtitle_color,
                                    'cust_name' => 'wp_rem_property_slider_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_properties_slider_seperator_style),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'wp_rem_properties_slider_seperator_style[]',
                                    'return' => true,
                                    'options' => array(
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($slider_properties_title_limit),
                                    'id' => 'slider_properties_title_limit',
                                    'cust_name' => 'slider_properties_title_limit[]',
                                    'return' => true,
                                ),
                            );
                            $wp_rem_html_fields->wp_rem_text_field($wp_rem_opt_array);
    ...
    function wp_rem_cs_save_page_builder_data_wp_rem_properties_slider_callback($args) {
        ...
        if ($widget_type == "wp_rem_properties_slider" || $widget_type == "cs_wp_rem_properties_slider") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['slider_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']]) && $data['slider_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_slider .= 'slider_properties_title="' . htmlspecialchars($data['slider_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_properties_slider_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']]) && $data['wp_rem_properties_slider_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_slider .= 'wp_rem_properties_slider_seperator_style="' . htmlspecialchars($data['wp_rem_properties_slider_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['wp_rem_property_slider_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']]) && $data['wp_rem_property_slider_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_slider .= 'wp_rem_property_slider_element_title_color="' . htmlspecialchars($data['wp_rem_property_slider_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_property_slider_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']]) && $data['wp_rem_property_slider_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_slider .= 'wp_rem_property_slider_element_subtitle_color="' . htmlspecialchars($data['wp_rem_property_slider_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['slider_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']]) && $data['slider_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_slider .= 'slider_properties_title_limit="' . htmlspecialchars($data['slider_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']]) && $data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_slider .= 'property_enquiry_switch="' . htmlspecialchars($data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']], ENT_QUOTES) . '" ';
                }
                if (isset($data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']]) && $data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']] != '') {
                    $wp_rem_cs_bareber_wp_rem_properties_slider .= 'property_notes_switch="' . htmlspecialchars($data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_slider']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_bareber_wp_rem_properties_slider, $data, $counters['wp_rem_cs_counter_wp_rem_properties_slider'], array( 'responsive_atts' => true ));
                 $wp_rem_cs_bareber_wp_rem_properties_slider = $section_title;
