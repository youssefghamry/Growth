    ...
    function wp_rem_cs_var_page_builder_wp_rem_propertysearch($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                ...
                'wp_rem_property_search_element_title_color' => '',
                'wp_rem_property_search_element_subtitle_color' => '',
                ...
                'wp_rem_property_search_seperator_style' => '',
            );
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_property_search_element_title_color,
                                    'cust_name' => 'wp_rem_property_search_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_property_search_element_subtitle_color,
                                    'cust_name' => 'wp_rem_property_search_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_property_search_seperator_style),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'wp_rem_property_search_seperator_style[]',
                                    'return' => true,
                                    'options' => array(
                            ...
                            $propertysearch_views = array(
                                ...
                                'fancy_v4' => wp_rem_plugin_text_srt('wp_rem_element_view_fancy_v4'),
                                ...
                                'modern_v4' => wp_rem_plugin_text_srt('wp_rem_search_element_style_modern_v4'),
                            ...
                            if ( isset($propertysearch_view) && ($propertysearch_view == 'fancy_v2' || $propertysearch_view == 'modern_v2' || $propertysearch_view == 'fancy_v3' || $propertysearch_view == 'fancy_v4' || $propertysearch_view == 'modern_v3' || $propertysearch_view == 'modern_v4') ) {
                            ...
                            if ( isset($propertysearch_view) && $propertysearch_view == 'modern_v4' ) {
                                $location_view_fields = 'none';
                            }
                            
                            echo '<div id="propertysearch_location_field_switch_' . $property_rand_id . '" style="display:' . $location_view_fields . ';">';
                            ...
                            if ( isset($propertysearch_view) && ($propertysearch_view == 'modern_v2' || $propertysearch_view == 'modern_v4') ) {
                            ...
                            if ( isset($propertysearch_view) && ($propertysearch_view == 'modern_v2' || $propertysearch_view == 'fancy_v3' || $propertysearch_view == 'modern_v3' || $propertysearch_view == 'modern_v4') ) {
                            ...
                            <script type="text/javascript">
                                ...
                                jQuery(document).on('change', '#wp_rem_propertysearch_view' + property_rand_id + '', function () {
                                    ...
                                    if (this.value == 'fancy_v2' || this.value == 'modern_v2' || this.value == 'fancy_v3' || this.value == 'fancy_v4' || this.value == 'modern_v3' || this.value == 'modern_v4') {
                                    ...
                                    if (this.value == 'modern_v4') {
                                        jQuery('#propertysearch_location_field_switch_<?php echo esc_html($property_rand_id); ?>').hide();
                                    } else {
                                        jQuery('#propertysearch_location_field_switch_<?php echo esc_html($property_rand_id); ?>').show();
                                    }
    ...
    function wp_rem_cs_save_page_builder_data_wp_rem_propertysearch_callback($args) {
        ...
        if ( $widget_type == "wp_rem_propertysearch" || $widget_type == "cs_wp_rem_propertysearch" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['wp_rem_property_search_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']]) && $data['wp_rem_property_search_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_propertysearch .= 'wp_rem_property_search_element_title_color="' . htmlspecialchars($data['wp_rem_property_search_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_property_search_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']]) && $data['wp_rem_property_search_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_propertysearch .= 'wp_rem_property_search_element_subtitle_color="' . htmlspecialchars($data['wp_rem_property_search_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['wp_rem_property_search_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']]) && $data['wp_rem_property_search_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_propertysearch .= 'wp_rem_property_search_seperator_style="' . htmlspecialchars($data['wp_rem_property_search_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_propertysearch']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_bareber_wp_rem_propertysearch, $data, $counters['wp_rem_cs_counter_wp_rem_propertysearch'], array( 'responsive_atts' => true ));
                $wp_rem_cs_bareber_wp_rem_propertysearch = $section_title;
                $wp_rem_cs_bareber_wp_rem_propertysearch .= ']';
