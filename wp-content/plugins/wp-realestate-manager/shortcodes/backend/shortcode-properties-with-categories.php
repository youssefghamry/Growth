...
if ( ! function_exists('wp_rem_cs_var_page_builder_wp_rem_properties_with_categories') ) {
    ...
    function wp_rem_cs_var_page_builder_wp_rem_properties_with_categories($die = 0) {
        ...
        if ( function_exists('wp_rem_cs_shortcode_names') ) {
            ...
            $defaults = array(
                'categories_properties_title' => '',
                'categories_properties_title_limit' => '',
                'properties_subtitle' => '',
                ...
                'wp_rem_property_categories_element_title_color' => '',
                'wp_rem_property_categories_element_subtitle_color' => '',
                'wp_rem_properties_with_categories_seperator_style' => '',
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($categories_properties_title),
                                    'id' => 'categories_properties_title',
                                    'cust_name' => 'categories_properties_title[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_property_categories_element_title_color,
                                    'cust_name' => 'wp_rem_property_categories_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_property_categories_element_subtitle_color,
                                    'cust_name' => 'wp_rem_property_categories_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_properties_with_categories_seperator_style),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'wp_rem_properties_with_categories_seperator_style[]',
                                    'return' => true,
                                    'options' => array(
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'field_params' => array(
                                    ...
                                    'cust_name' => 'property_types_all[]',
                                    'extra_atr' => 'data-id="' . $property_rand_id . '"',
                                    'return' => true,
                            ...
                            $wp_rem_html_fields->wp_rem_select_field($wp_rem_opt_array);
                            ?>
                            <div class="type-categories-selection"><?php echo get_property_cats_by_type_callback($property_type, $property_category, false, $property_rand_id); ?></div>
                            <script>
                                jQuery(document).ready(function () {
                                    console.log('<?php echo $property_type; ?>');
                                    console.log('<?php echo $property_category; ?>');
                                    jQuery(".save_property_types_<?php echo absint($property_rand_id); ?>").click(function () {
                                        var MY_SELECT = jQuery('#wp_rem_property_types_<?php echo absint($property_rand_id); ?>').val();
                                        var property_type_value = MY_SELECT;
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'field_params' => array(
                                    'std' => esc_attr($categories_properties_title_limit),
                                    'id' => 'categories_properties_title_limit',
                                    'cust_name' => 'categories_properties_title_limit[]',
                                    'return' => true,
                                ),
                            );
                            $wp_rem_html_fields->wp_rem_text_field($wp_rem_opt_array);
                        ...
                        <?php } else { ?>
                            ...
                            $wp_rem_cs_opt_array = array(
                                ...
                                'field_params' => array(
                                    ...
                                    'classes' => 'wp_rem_properties_with_categories_save_' . $property_rand_id .' cs-wp_rem_cs-admin-btn save_property_types_' . $property_rand_id . ' save_property_locations_' . $property_rand_id . '',
    ...
    function wp_rem_cs_save_page_builder_data_wp_rem_properties_with_categories_callback($args) {
        ...
        if ( $widget_type == "wp_rem_properties_with_categories" || $widget_type == "cs_wp_rem_properties_with_categories" ) {
            ...
            if ( isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode' ) {
                ...
                if ( isset($data['categories_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['categories_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_properties_with_categories .= 'categories_properties_title="' . htmlspecialchars($data['categories_properties_title'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_property_categories_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['wp_rem_property_categories_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_properties_with_categories .= 'wp_rem_property_categories_element_title_color="' . htmlspecialchars($data['wp_rem_property_categories_element_title_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['wp_rem_property_categories_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['wp_rem_property_categories_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_properties_with_categories .= 'wp_rem_property_categories_element_subtitle_color="' . htmlspecialchars($data['wp_rem_property_categories_element_subtitle_color'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['wp_rem_properties_with_categories_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['wp_rem_properties_with_categories_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_properties_with_categories .= 'wp_rem_properties_with_categories_seperator_style="' . htmlspecialchars($data['wp_rem_properties_with_categories_seperator_style'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']], ENT_QUOTES) . '" ';
                }
                if ( isset($data['categories_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['categories_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_properties_with_categories .= 'categories_properties_title_limit="' . htmlspecialchars($data['categories_properties_title_limit'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_properties_with_categories .= 'property_enquiry_switch="' . htmlspecialchars($data['property_enquiry_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']], ENT_QUOTES) . '" ';
                }
                
                if ( isset($data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                    $wp_rem_cs_bareber_wp_rem_properties_with_categories .= 'property_notes_switch="' . htmlspecialchars($data['property_notes_switch'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']], ENT_QUOTES) . '" ';
                }
                ...
                if ( isset($data['property_location'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']]) && $data['property_location'][$counters['wp_rem_cs_counter_wp_rem_properties_with_categories']] != '' ) {
                 ...
                 $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_bareber_wp_rem_properties_with_categories, $data, $counters['wp_rem_cs_counter_wp_rem_properties_with_categories'], array( 'responsive_atts' => true ));
                
                $wp_rem_cs_bareber_wp_rem_properties_with_categories = $section_title;
                $wp_rem_cs_bareber_wp_rem_properties_with_categories .= ']';
...
if ( ! function_exists('get_property_cats_by_type_callback') ) {
    ...
    function get_property_cats_by_type_callback($property_type = '', $property_category = '', $is_ajax = true, $property_element_rand_id = '') {
        global $wp_rem_html_fields, $wp_rem_form_fields;
        $property_element_rand_id = isset($_POST['property_element_rand_id']) ? $_POST['property_element_rand_id'] : $property_element_rand_id;
        ...
        $property_rand_id = rand(1000, 9999);
        ...
        <script>
            jQuery(document).ready(function () {
                chosen_selectionbox();
                jQuery(".wp_rem_properties_with_categories_save_<?php echo $property_element_rand_id; ?>").click(function () {
                    var MY_SELECT = jQuery('#wp_rem_property_categories_<?php echo absint($property_rand_id); ?>').get(0);
