...
if ( ! function_exists('wp_rem_cs_var_contact_us_data') ) {
    ...
    function wp_rem_cs_var_contact_us_data($atts, $content = "") {
        ...
        $strings->wp_rem_cs_var_frame_all_string_all();
        ...
        $html .= wp_rem_title_sub_align($wp_rem_cs_contactus_section_title, $wp_rem_cs_contact_us_element_subtitle, $wp_rem_var_contact_us_align, $wp_rem_cs_var_contact_form_title_color,$wp_rem_var_contact_form_seperator_style, $wp_rem_cs_var_contact_form_subtitle_color);
