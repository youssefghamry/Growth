<?php
/**
 * Received Property Claim Email Template
 *
 * @since 1.0
 * @package	Homevillas
 */

if ( ! class_exists( 'Wp_rem_property_claim_email_template' ) ) {

	class Wp_rem_property_claim_email_template {
		...
		public function __construct() {
			...
			$this->email_template_type = 'Received Property Claim';

			$this->email_default_template = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"/></head><body style="margin: 0; padding: 0;"><div style="background-color: #eeeeef; padding: 50px 0;"><table style="max-width: 640px;" border="0" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e"><h1 style="color: #fff;">Received Property Claim</h1></td></tr><tr><td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td width="260" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding-bottom: 8px;">Hi, [SITE_NAME]</td></tr><tr><td style="padding-bottom: 8px;">[CLAIM_USER_NAME] has submitted a claim on property ( <a href="[PROPERTY_LINK]">[PROPERTY_TITLE]</a> ).</td></tr><tr><td style="padding-bottom: 8px;">Name: [CLAIM_USER_NAME]</td></tr><tr><td style="padding-bottom: 8px;">Email: [CLAIM_USER_EMAIL]</td></tr><tr><td style="padding-bottom: 8px;">Reason: [CLAIM_REASON]</td></tr></tbody></table></td></tr></table></td></tr><tr><td style="background-color: #ffffff; padding: 30px 30px 30px 30px;"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="font-family: Arial, sans-serif; font-size: 14px;">&reg; [SITE_NAME], 2017</td></tr></tbody></table></td></tr></tbody></table></div></body></html>';
			...
			$this->email_template_index = 'received-claim-template';
			...
			add_action( 'wp_rem_received_claim_email', array( $this, 'wp_rem_received_claim_email_callback' ), 10, 1 );
		}

		public function wp_rem_received_claim_email_callback( $form_fields = array() ) {
			...
			if ( isset( $template['email_notification'] ) && $template['email_notification'] == 1 ) {
				...
				$subject = (isset( $template['subject'] ) && $template['subject'] != '' ) ? $template['subject'] : wp_rem_plugin_text_srt( 'wp_rem_received_property_claim' );
				...
				Wp_rem_property_claim_email_template::$is_email_sent1 = $this->is_email_sent;
			}
		}
		...
		public function add_email_template() {
			...
			$email_templates[$this->template_group][$this->email_template_index] = array(
				...
				'description' => wp_rem_plugin_text_srt( 'wp_rem_received_property_claim_email' ),
				'jh_email_type' => 'html',
			);
		...
		function get_claim_user_name() {
			return isset( $this->form_fields['wp_rem_claim_property_user_name'] ) ? $this->form_fields['wp_rem_claim_property_user_name'] : '';
		}
		function get_claim_user_email() {
			return isset( $this->form_fields['wp_rem_claim_property_user_email'] ) ? $this->form_fields['wp_rem_claim_property_user_email'] : '';
		}
		function get_claim_user_reason() {
			return isset( $this->form_fields['wp_rem_claim_property_reason'] ) ? $this->form_fields['wp_rem_claim_property_reason'] : '';
		}
	...
	new Wp_rem_property_claim_email_template();
}
