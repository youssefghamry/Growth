    ...
    function wp_rem_cs_var_page_builder_pricing_table($die = 0) {
        ...
        if (function_exists('wp_rem_cs_shortcode_names')) {
            ...
            $defaults = array(
                ...
                'wp_rem_pricing_table_element_subtitle_color' => '',
                'wp_rem_pricing_table_element_title_color' => '',
                 'wp_rem_pricing_plan_seperator_style'=>'', 
            );
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_pricing_table_element_title_color,
                                    'cust_name' => 'wp_rem_pricing_table_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            $wp_rem_html_fields->wp_rem_text_field($wp_rem_opt_array);
                             ...
                             $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_pricing_table_element_subtitle_color,
                                    'cust_name' => 'wp_rem_pricing_table_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_pricing_plan_seperator_style),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'wp_rem_pricing_plan_seperator_style[]',
                                    'return' => true,
                                    'options' => array(
    ...
    function wp_rem_cs_save_page_builder_data_pricing_table_callback($args) {
        ...
        if ($widget_type == "pricing_table" || $widget_type == "cs_pricing_table") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['wp_rem_pricing_plan_seperator_style'][$counters['wp_rem_cs_counter_pricing_table']]) && $data['wp_rem_pricing_plan_seperator_style'][$counters['wp_rem_cs_counter_pricing_table']] != '') {
                    $wp_rem_cs_bareber_pricing_table .= 'wp_rem_pricing_plan_seperator_style="' . htmlspecialchars($data['wp_rem_pricing_plan_seperator_style'][$counters['wp_rem_cs_counter_pricing_table']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['wp_rem_pricing_table_element_subtitle_color'][$counters['wp_rem_cs_counter_pricing_table']]) && $data['wp_rem_pricing_table_element_subtitle_color'][$counters['wp_rem_cs_counter_pricing_table']] != '') {
                    $wp_rem_cs_bareber_pricing_table .= 'wp_rem_pricing_table_element_subtitle_color="' . htmlspecialchars($data['wp_rem_pricing_table_element_subtitle_color'][$counters['wp_rem_cs_counter_pricing_table']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_pricing_table_element_title_color'][$counters['wp_rem_cs_counter_pricing_table']]) && $data['wp_rem_pricing_table_element_title_color'][$counters['wp_rem_cs_counter_pricing_table']] != '') {
                    $wp_rem_cs_bareber_pricing_table .= 'wp_rem_pricing_table_element_title_color="' . htmlspecialchars($data['wp_rem_pricing_table_element_title_color'][$counters['wp_rem_cs_counter_pricing_table']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_pricing_tables'][$counters['wp_rem_cs_counter_pricing_table']]) && $data['wp_rem_pricing_tables'][$counters['wp_rem_cs_counter_pricing_table']] != '') {
                 ...
                 // Apply filter on default attributes Saving
                    $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_cs_bareber_pricing_table, $data, $counters['wp_rem_cs_counter_pricing_table'], array( 'responsive_atts' => true ));
                
                 $wp_rem_cs_bareber_pricing_table = $section_title;
                $wp_rem_cs_bareber_pricing_table .= ']';
