...
if ( ! class_exists('wp_rem_yelp_list_results') ) {
    ...
    class wp_rem_yelp_list_results {
        ...
        public function __construct() {
            add_action('wp_rem_property_yelp_results_html', array( $this, 'wp_rem_property_yelp_results_html_callback' ), 10, 1);
            add_action('wp_ajax_wp_rem_property_yelp_results', array( $this, 'wp_rem_property_yelp_results_callback' ));
            add_action('wp_ajax_nopriv_wp_rem_property_yelp_results', array( $this, 'wp_rem_property_yelp_results_callback' ));
         ...
         * */
        public function wp_rem_property_yelp_results_html_callback($property_id = '') {
			...
			if ( $wp_rem_yelp_places_element != 'off' && is_array($terms) && $access_token != '' && $lat != '' && $long != '' ) {
				?>
				<div class="ysection property-detail-section-loader" id="property_detail_yelp_result_<?php echo absint($property_id); ?>" style="min-height:305px;">
					<script>
						jQuery(document).ready(function () {
							wp_rem_load_yelp_places(<?php echo absint($property_id); ?>);
						});
					</script>
				</div>
				<?php
         ...
         * */
        public function wp_rem_property_yelp_results_callback() {
            global $wp_rem_plugin_options;
            ...
            if ( is_array($terms) && $access_token != '' && $lat != '' && $long != '' ) {
                $result .='<div id="best-of-yelp-module">
					<div class="element-title">
						<h3>' . wp_rem_plugin_text_srt('wp_rem_yelp_places_nearby') . '</h3>
						<div class="yelp-logo">
							<a href="https://yelp.com" target="_blank"><img src="' . wp_rem::plugin_url() . 'assets/frontend/images/yelp-logo.png" alt=""></a>
						</div>
					</div>
					<div class="stage">
                        ...
                        if ( is_array($data) && isset($data['businesses']) && ! empty($data['businesses']) ) {
                            ...
                            foreach ( $data['businesses'] as $data_business ) {
                                ...
                                if ( $image_url != '' ) {
                                    ...
                                    $result .='<div class="media-avatar" style="background-image:url(\'' . trailingslashit(wp_rem::plugin_url()) . 'assets/frontend/images/yelp-no-img.png\');background-size: 100%;">
                                                        <div class="photo-box">
                                                                <a href="' . esc_url_raw($business_url) . '" target="_blank"></a>
                                                        </div>
                                                </div>';
                                ...
                                $result .='<div class="media-story">' . force_balance_tags($business_cats_str) . '
                                    ...
                                    <div class="biz-rating biz-rating-medium">
                                        ...
                                        <span class="review-count rating-qualifier">' . sprintf(wp_rem_plugin_text_srt('wp_rem_yelp_places_reviews'), absint($business_total_reviews)) . '</span>
                                    </div>
            ...
            if ( is_array($terms) && $access_token != '' && $lat != '' && $long != '' ) {
                ...
                <div id="best-of-yelp-module" class="ysection">
                    <div class="element-title">
                        ...
                        <div class="yelp-logo">
                            <a href="https://yelp.com" target="_blank"><img src="<?php echo wp_rem::plugin_url() ?>assets/frontend/images/yelp-logo.png" alt=""></a>
                        </div>
                    </div>
                    <div class="stage">
                        <div class="best-of-yelp-main">
