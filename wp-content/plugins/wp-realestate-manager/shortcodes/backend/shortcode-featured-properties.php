    ...
    function wp_rem_cs_var_page_builder_wp_rem_featured_properties($die = 0) {
        ...
        if (function_exists('wp_rem_cs_shortcode_names')) {
            ...
            $defaults = array(
                ...
                'properties_subtitle' => '',
                'featured_properties_title_limit' => '20',
                'featured_properties_title_alignment' => '',
                ...
                'wp_rem_featured_property_element_subtitle_color' => '',
                'wp_rem_featured_property_element_title_color' => '',
                'wp_rem_featured_properties_seperator_style' => '',
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($featured_properties_title),
                                    'id' => 'featured_properties_title',
                                    'cust_name' => 'featured_properties_title[]',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($featured_properties_title_alignment),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'featured_properties_title_alignment[]',
                                    'return' => true,
                                    'options' => array(
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_featured_property_element_title_color,
                                    'cust_name' => 'wp_rem_featured_property_element_title_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $wp_rem_featured_property_element_subtitle_color,
                                    'cust_name' => 'wp_rem_featured_property_element_subtitle_color[]',
                                    'classes' => 'bg_color',
                                    'return' => true,
                                ),
                            );
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($wp_rem_featured_properties_seperator_style),
                                    'classes' => 'chosen-select-no-single',
                                    'cust_name' => 'wp_rem_featured_properties_seperator_style[]',
                                    'return' => true,
                                    'options' => array(
                            ...
                            $wp_rem_opt_array = array(
                                ...
                                'echo' => true,
                                'field_params' => array(
                                    'std' => esc_attr($featured_properties_title_limit),
                                    'id' => 'featured_properties_title_limit',
                                    'cust_name' => 'featured_properties_title_limit[]',
                                    'return' => true,
                                ),
                            );
                            $wp_rem_html_fields->wp_rem_text_field($wp_rem_opt_array);
    ...
    function wp_rem_cs_save_page_builder_data_wp_rem_featured_properties_callback($args) {
        ...
        if ($widget_type == "wp_rem_featured_properties" || $widget_type == "cs_wp_rem_featured_properties") {
            ...
            if (isset($data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']]) && $data['wp_rem_cs_widget_element_num'][$counters['wp_rem_cs_counter']] == 'shortcode') {
                ...
                if (isset($data['featured_properties_title'][$counters['wp_rem_featured_properties_counter']]) && $data['featured_properties_title'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'featured_properties_title="' . htmlspecialchars($data['featured_properties_title'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                if (isset($data['featured_properties_title_alignment'][$counters['wp_rem_featured_properties_counter']]) && $data['featured_properties_title_alignment'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'featured_properties_title_alignment="' . htmlspecialchars($data['featured_properties_title_alignment'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_featured_property_element_subtitle_color'][$counters['wp_rem_featured_properties_counter']]) && $data['wp_rem_featured_property_element_subtitle_color'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'wp_rem_featured_property_element_subtitle_color="' . htmlspecialchars($data['wp_rem_featured_property_element_subtitle_color'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_featured_property_element_title_color'][$counters['wp_rem_featured_properties_counter']]) && $data['wp_rem_featured_property_element_title_color'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'wp_rem_featured_property_element_title_color="' . htmlspecialchars($data['wp_rem_featured_property_element_title_color'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                if (isset($data['featured_properties_title_limit'][$counters['wp_rem_featured_properties_counter']]) && $data['featured_properties_title_limit'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'featured_properties_title_limit="' . htmlspecialchars($data['featured_properties_title_limit'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                if (isset($data['wp_rem_featured_properties_seperator_style'][$counters['wp_rem_featured_properties_counter']]) && $data['wp_rem_featured_properties_seperator_style'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'wp_rem_featured_properties_seperator_style="' . htmlspecialchars($data['wp_rem_featured_properties_seperator_style'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                ...
                if (isset($data['property_enquiry_switch'][$counters['wp_rem_featured_properties_counter']]) && $data['property_enquiry_switch'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'property_enquiry_switch="' . htmlspecialchars($data['property_enquiry_switch'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                if (isset($data['property_hide_switch'][$counters['wp_rem_featured_properties_counter']]) && $data['property_hide_switch'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'property_hide_switch="' . htmlspecialchars($data['property_hide_switch'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                if (isset($data['property_notes_switch'][$counters['wp_rem_featured_properties_counter']]) && $data['property_notes_switch'][$counters['wp_rem_featured_properties_counter']] != '') {
                    $wp_rem_featured_properties .= 'property_notes_switch="' . htmlspecialchars($data['property_notes_switch'][$counters['wp_rem_featured_properties_counter']], ENT_QUOTES) . '" ';
                }
                ...
                $section_title = apply_filters('wp_rem_shortcode_default_atts_save', $wp_rem_featured_properties, $data, $counters['wp_rem_featured_properties_counter'], array( 'responsive_atts' => true ));
                
                 $wp_rem_featured_properties = $section_title;
                $wp_rem_featured_properties .= ']';
