...
class Wp_rem_Property_Alerts {
    ...
    public function __construct() {
        ...
        $this->email_default_template = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/></head><body style="margin: 0; padding: 0;"><div style="background-color: #eeeeef; padding: 50px 0;"><table style="max-width: 640px;" border="0" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="padding: 40px 30px 30px 30px;" align="center" bgcolor="#33333e"><h1 style="color: #fff;">Property Alert</h1></td></tr><tr><td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td>Hello! Following are the properties for which you have subscribed at [SITE_NAME]</td></tr><tr><td style="padding: 10px 0 0 0;">Property Alert Title: [LSITING_ALERT_TITLE]</td></tr><tr><td style="padding: 10px 0 0 0;">[LSITING_ALERT_LSITINGS_LIST]</td></tr><tr><td style="padding: 10px 0 0 0;">All Properties Property Link: [LSITING_ALERT_FULL_PROPERTY_URL]</td></tr><tr><td style="padding: 10px 0 0 0;">Properties Count: [LSITING_ALERT_TOTAL_LSITINGS_COUNT]</td></tr><tr><td style="padding: 10px 0 0 0;">Alert Frequency: [LSITING_ALERT_FREQUENCY]</td></tr><tr><td style="padding: 10px 0 0 0;">To unsubscribe property alert: [LSITING_ALERT_UNSUBSCRIBE_LINK]</td></tr></table></td></tr><tr><td style="background-color: #ffffff; padding: 30px 30px 30px 30px;"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><td style="font-family: Arial, sans-serif; font-size: 14px;">&reg; [SITE_NAME], 2016</td></tr></tbody></table></td></tr></tbody></table></div></body></html>';
    ...
    public function init() {
        ...
        add_action('init', array( $this, 'add_email_template_callback' ), 13);
    }
    ...
    public function frontend_ui_callback() {
        ...
        //$this->after_properties_property_callback();
        ?>
                            ...
                            <div class="property-alert-box property-alert property-alert-container-top" >
                                ...
                                <div class="newsletter">
                                    ...
                                    $wp_rem_field_opt = array(
                                        ...
                                        'std' => '',
                                        'desc' => '',
                                        'classes' => 'form-control name-input-top wp-rem-dev-req-field',
                                        'extra_atr' => ' onkeypress="wp_rem_contact_form_valid_press(this,\'text\')" placeholder="' . wp_rem_plugin_text_srt('wp_rem_alerts_alert_name_title') . '" maxlength="75"',
                                        'hint_text' => '',
                                    );
                                    ...
                                    $wp_rem_field_opt = array(
                                        ...
                                        'std' => $email,
                                        'desc' => '',
                                        'classes' => 'form-control email-input-top alerts-email wp-rem-dev-req-field wp-rem-email-field',
                                        'extra_atr' => $disabled . ' placeholder="' . wp_rem_plugin_text_srt('wp_rem_alerts_email_address') . '" onkeypress="wp_rem_contact_form_valid_press(this,\'email\')" ',
                                        'hint_text' => '',
                                    );
                                    $wp_rem_form_fields_frontend->wp_rem_form_text_render($wp_rem_field_opt);
                                    echo '</div>';
    ...
    public static function get_full_property_url() {
        if ( isset(self::$property_details['id']) ) {
            ...
            return '<a href="' . wp_rem_wpml_lang_page_permalink($page, 'page') . '?' . self::$property_details['url_query'] . '">' . wp_rem_plugin_text_srt('wp_rem_alerts_view_full_property') . '</a>';
        }
        return false;
    }

    public static function get_property_alerts_count($properties_query = array(), $frequency = '') {
		if ( ! is_array($properties_query) ) {
